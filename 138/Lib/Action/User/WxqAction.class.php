...
class WxqAction extends UserAction{
    ...
    public function incoming(){
        ...
        $sql = "SELECT id, content, from_user, type, createtime FROM wy_wxwall_message WHERE wxq_id = '{$id}'";
        ...
        if(!empty($rowBefore)){
            ...
            M('wxwall_message') -> where(array('id' => $row['id'])) -> save(array('isshowed' => 1));
    ...
    public function award(){
        ...
        $data = array('wxq_id' => $message['wxq_id'], 'from_user' => $message['from_user'], 'createtime' => time(), 'status' => 0,);
