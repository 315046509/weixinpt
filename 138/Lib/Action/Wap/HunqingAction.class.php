...
class HunqingAction extends BaseAction
{
    ...
    public function _initialize()
    {
        ...
        $get_ids = M('Estate')->where(array('token'=>$this->token,'thetype' => 'Hunqing'))->field('res_id,classify_id')->find();
    ...
    public function news()
    {
        $data        = M("Estate");
        $this->token = $this->_get('token');
        $where       = array('token' => $this->token,'thetype' => 'Hunqing');
    ...
    public function housetype()
    {
        ...
        $where       = array('token' => $this->_get('token'),'thetype' => 'Hunqing');
