...
class LuckyFruitAction extends LotteryBaseAction{
    ...
    public function getajax(){
        ...
        if ($data['prizetype'] >= 1 && $data['prizetype'] <= 6){
            ...
            case 1: $prizeName = '一等奖' . $Lottery['fist'];
                break;
            case 2: $prizeName = '二等奖' . $Lottery['second'];
                break;
            case 3: $prizeName = '三等奖' . $Lottery['third'];
                break;
            case 4: $prizeName = '四等奖' . $Lottery['four'];
                break;
            case 5: $prizeName = '五等奖' . $Lottery['five'];
                break;
            case 6: $prizeName = '六等奖' . $Lottery['six'];
                break;
            }
