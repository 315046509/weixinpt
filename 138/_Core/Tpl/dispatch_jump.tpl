...
<head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <style type="text/css">
		...
		a{color:#333}
		a:hover{color:#333}
		.z{ margin-top:-40px; width:150px; height:150px; float:left;background:#fff url({weiwin::C('site_url')}/tpl/static/images/tipsicon.gif) no-repeat left -150px;}
		.c{ margin-top:-40px; width:150px; height:150px; float:left;background:#fff url({weiwin::C('site_url')}//tpl/static/images/tipsicon.gif) no-repeat left -450px;}
