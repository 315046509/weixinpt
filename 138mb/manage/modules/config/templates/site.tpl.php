     ...
     <table class="addTable">
      <tr style="display:none">
       ...
       <tr>
        ...
        <tr>
          <th>首页域名</th>
          <td><input type="text" onfocus="this.removeClass('colorblur');this.addClass('colorfocus');" onblur="this.removeClass('colorfocus');this.addClass('colorblur');" id="url" name="info[url]" size="60" class="colorblur" value="<?php echo $thisSite['url'];?>"> <span class="tdtip">比如www.baidu.com 不包含"http://" 结尾不含"/"</span></td>
        </tr>
        <tr style="display:none">
          <th>回复图片</th>
