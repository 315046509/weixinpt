...
//定义回调URL通用的URL
define('URL_CALLBACK', 'http://www.138wo.com/index.php/callback?type=');

return array(
	//腾讯QQ登录配置
	'THINK_SDK_QQ' => array(
		'APP_KEY'    => '101026049', //应用注册成功后分配的 APP ID
		'APP_SECRET' => '8b237621dbae66884c8de113a0db4e45', //应用注册成功后分配的KEY
