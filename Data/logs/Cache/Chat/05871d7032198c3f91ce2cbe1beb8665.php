			...
			$objct=eval(data);
			  ...
			  $($objct).each(function(d){
				...
				if('undefined' != typeof($('#'+$opnid))){
					...
					$str='<div class="chatListColumn" id="'+$opnid+'" onclick="selected(\''+$opnid+'\',1)"> <div class="clicked" style="display:none;"></div><span class="unreadDot" style="display:none">0</span> <span class="unreadDotS" style="display:none"></span><div class="avatar_wrap"><img class="avatar" src="index.php?g=Chat&m=&a=showExternalPic&url='+$headimgurl+'" /></div><span id="showNums'+$opnid+'" class="unreadDot" style="display: block;">1</span><div class="extend"><p class="time">'+$subscribe_time+'</p>   <div class="edited"><i class="editedIcon"></i></div> <div class="mute" style="display:none;"></div></div><div class="info"> <div class="nickName"><div class="left name" style="">'+$nickname+'</div><div class="clr"></div></div> <div class="descWrapper"> <p class="desc">'+$city+'</p> </div></div> <div class="clr"></div> </div>';
		clickMisic();
					...
					<div id="profile" class="title"> 
						<div class="myProfile"> 
							...
							<div class="operaterBox" style="display:none;" id="textMen">  
								...
								<a href="javascript:;" class="iconOperater" id="toggleSysMenu"></a> 
						</div>
						<div class="clr"></div>
					</div>
				</div>
							...
							<div id="conversationContainer">
								<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><div class="chatListColumn" id="<?php echo ($list["openid"]); ?>" onClick="selected('<?php echo ($list["openid"]); ?>',<?php echo ($i); ?>)"> 
									...
									<div class="avatar_wrap">
										<img class="avatar" src="<?php if($list['headimgurl'] != ''): ?>index.php?g=Chat&m=&a=showExternalPic&url=<?php echo ($list["headimgurl"]); else: ?>/tpl/Chat/default/style/css/img/avatar_default17ced3.png<?php endif; ?>" />
									</div>
									<div class="extend">
