...
<form id="myform" action="<?php echo U('Site/insert');?>" method="post">
    ...
    <tr> 
      ...
      <td><input type="text" name="server_topdomain" value="<?php echo C('server_topdomain');?>" class="ipt" size="45" />
      <span>&nbsp;&nbsp;比如:wx.wxdcl.com</span>
	...
	<tr> 
      ...
      <td><textarea	 type="text" name="counts" class="ipt" style="width:252px;height:25px;margin:5px 0 5px 0;" />
      <?php echo C('counts');?></textarea><span>&nbsp;&nbsp;例:15222274119</span>
	</tr>
	...
	<tr> 
      ...
      <span>&nbsp;&nbsp;例如:QQ:3669955@qq.com</span>
      ...
      <td><textarea	 type="text" name="about" class="ipt" style="width:450px;height:100px;margin:5px 0 5px 0;" /><?php echo C('about');?></textarea><span>&nbsp;&nbsp;公司介绍</span>
	...
	<tr> 
      ...
      <?php echo C('copyright');?></textarea><span>&nbsp;&nbsp;例:宏宏CMS版权所有</span>
