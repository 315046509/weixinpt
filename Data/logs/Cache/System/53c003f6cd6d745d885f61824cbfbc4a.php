...
<head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    ...
    <style type="text/css">
		...
		a{color:#333}
		a:hover{color:#333}
		.z{ margin-top:-40px; width:150px; height:150px; float:left;background:#fff url(<?php echo C('site_url');?>/tpl/static/images/tipsicon.gif) no-repeat left -150px;}
		.c{ margin-top:-40px; width:150px; height:150px; float:left;background:#fff url(<?php echo C('site_url');?>//tpl/static/images/tipsicon.gif) no-repeat left -450px;}
...
<body>
<div style="width:470px; height:260px; margin-top:30px; margin-left: auto;margin-right: auto; text-align:center;">
    <div class="systips animated bounceIn">
        <div class="systips_detail">
		<div style="margin-top:-30px;">
            <div class="tip_title">提示信息</div>
			...
			本页<span id="wait" style="font-weight:bold;"><?php echo($waitSecond);?></span>秒后将自动<a id="href" href="<?php echo($jumpUrl); ?>">跳转</a></div>
		</div>
    </div>
</div>
