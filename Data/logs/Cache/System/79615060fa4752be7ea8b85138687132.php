...
<table width="100%" border="0" cellspacing="0" cellpadding="0" id="addn">
 <form id="myform" action="<?php echo U('Site/insert');?>" method="post">
    ...
    <tr> 
      ...
      <td><input type="text" name="email_server" value="<?php echo C('email_server');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例：smtp.qq.com</span>
	  </td>
    </tr>
	 <tr> 
      <td  height="48" align="right"><strong>服务器端口：</strong></td>
      <td><input type="text" name="email_port" value="<?php echo C('email_port');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;默认：25</span>
	...
	<!--<tr> 
	 ...
	 <tr> 
      ...
      <td><input type="text" name="email_user" value="<?php echo C('email_user');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;例:1003959@qq.com</span>
    </tr> 
	<tr> 
      <td  height="48" align="right"><strong>密  码：</strong></td>
      <td><input type="text" name="email_pwd" value="<?php echo C('email_pwd');?>" class="ipt" size="45" /><span>&nbsp;&nbsp;邮箱的登录密码</span>
    </tr>
	<!--<tr> 
