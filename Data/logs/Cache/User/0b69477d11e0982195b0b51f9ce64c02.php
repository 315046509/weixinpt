...
<div class="cLineE">
<h4 class="left"><span style="font-size:18px; text-align:inherit; color:#666"><?php echo ($diaoyan["title"]); ?> </span> 的题目列表 -- 参与人数 <span style="font-size:18px; text-align:inherit; color:#666"><?php echo ($count); ?></span> 人 </h4>
...
<div class="msgWrap">
	...
	<table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
		<?php if(is_array($timu)): $i = 0; $__LIST__ = $timu;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><thead>
				<tr>
					<th width="100"><?php echo ($item["title"]); ?></th>
					<th width="100">选项票数</th>
				</tr>
			</thead>
			<tbody>
				<?php if($item['optia'] != ''){ ?>
					<tr>
						<td><?php echo ($item["optia"]); ?></td>
						<td><?php echo ($item["perca"]); ?></td>
					</tr>
				<?php } ?>
				
				<?php if($item['optib'] != ''){ ?>
					<tr>
						<td><?php echo ($item["optib"]); ?></td>
						<td><?php echo ($item["percb"]); ?></td>
					</tr>
				<?php } ?>
				
				<?php if($item['optic'] != ''){ ?>
					<tr>
						<td><?php echo ($item["optic"]); ?></td>
						<td><?php echo ($item["percc"]); ?></td>
					</tr>
				<?php } ?>
				
				<?php if($item['optid'] != ''){ ?>
					<tr>
						<td><?php echo ($item["optid"]); ?></td>
						<td><?php echo ($item["percd"]); ?></td>
					</tr>
				<?php } ?>
				
				<?php if($item['optie'] != ''){ ?>
					<tr>
						<td><?php echo ($item["optie"]); ?></td>
						<td><?php echo ($item["perce"]); ?></td>
					</tr>
				<?php } ?>
