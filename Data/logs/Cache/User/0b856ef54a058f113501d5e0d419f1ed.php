...
<div class="pageNavigator left"> <a href='/index.php?g=User&m=Member_card&a=noticeSet&id=<?php echo ($thisCard["id"]); ?>&token=<?php echo ($token); ?>' title='添加通知' class='btn btn-primary'>添加通知</a></div>
