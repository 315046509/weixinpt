...
<div class="tab">
<ul>
<li class="<?php if(ACTION_NAME == 'index'): ?>current<?php endif; ?> tabli" id="tab0"><a href="<?php echo U('Lvyou/index',array('token'=>$token));?>">旅游区简介</a></li>
<li class="<?php if(ACTION_NAME == 'son' ): ?>current<?php endif; ?> tabli" id="tab2"><a href="<?php echo U('Lvyou/son',array('token'=>$token));?>">景区</a></li>
<li class="<?php if(ACTION_NAME == 'housetype' ): ?>current<?php endif; ?> tabli" id="tab2"><a href="<?php echo U('Lvyou/housetype',array('token'=>$token));?>">景点</a></li>
<li class="<?php if(ACTION_NAME == 'album' or ACTION_NAME == 'album_add'): ?>current<?php endif; ?> tabli" id="tab5"><a href="<?php echo U('Lvyou/album',array('token'=>$token));?>">风景相册</a></li>
<li class="<?php if(ACTION_NAME == 'expert'): ?>current<?php endif; ?> tabli" id="tab5"><a href="<?php echo U('Lvyou/expert',array('token'=>$token));?>">游客点评</a></li>
<li class="<?php if(ACTION_NAME == 'Reservation'): ?>current<?php endif; ?> tabli" id="tab6"><a href="<?php echo U('Reservation/lvyouindex',array('token'=>$token,'thetype'=>'estate'));?>">预定门票</a></li>
</ul>
</div>
...
<?php if($es_data['id'] != ''): ?><input type="hidden" name="id" value="<?php echo ($es_data['id']); ?>" /><?php endif; ?>
	...
	<div class="control-group">
		...
		<div class="controls">
      <img class="thumb_img" id="cover_src" src="<?php echo (($es_data['cover'])?($es_data['cover']):'./tpl/static/sucai/lvyou/1.jpg'); ?>" style="max-height:100px;">
     	<input type="text" name="cover" value="<?php echo (($es_data['cover'])?($es_data['cover']):'./tpl/static/sucai/lvyou/1.jpg'); ?>" id="cover" class="px" style="width:150px;"  ><script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('cover',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a> 
	...
	<div class="control-group">
         <label class="control-label">旅游区头部图片：</label>
                                    <div class="controls">
                                        <img class="thumb_img" id="banner_src" src="<?php echo (($es_data['banner'])?($es_data['banner']):'./tpl/static/sucai/lvyou/2.png'); ?>" style="max-height:100px;"> 
                                        
                                            <input type="text" id="banner" name="banner" class="px" value="<?php echo (($es_data['banner'])?($es_data['banner']):'./tpl/static/sucai/lvyou/2.png'); ?>"><script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('banner',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
	...
	<div class="control-group">
		<div class="control-group">
                                    ...
                                    <div class="controls">
                                        <img class="thumb_img" id="house_banner_src" src="<?php echo (($es_data['house_banner'])?($es_data['house_banner']):'./tpl/static/sucai/lvyou/4.png'); ?>" style="max-height:100px;">
                                        <input type="text" name="house_banner" id="house_banner" class="px" value="<?php echo (($es_data['house_banner'])?($es_data['house_banner']):'./tpl/static/sucai/lvyou/4.png'); ?>"><script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('house_banner',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
