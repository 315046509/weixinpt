...
<?php else: ?>
 ...
 <a href="<?php echo U('Flash/add',array('tip'=>$tip));?>" class="btn btn-primary" ><?php if($tip == 1): ?>添加幻灯片<?php else: ?>添加背景图<?php endif; ?></a> 
</div>
...
<th style=" width:120px;"><?php if($tip == 1): ?>幻灯片排序<?php else: ?>背景图排序<?php endif; ?></th>
...
<td class="norightborder">
	<a href="<?php echo C('site_url');?>/index.php?g=Wap&m=Index&a=index&token=<?php echo ($token); ?>&wecha_id={wechat_id}" target="_blank">查看</a>
