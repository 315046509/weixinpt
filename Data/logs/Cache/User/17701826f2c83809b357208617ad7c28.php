      ...
      <TABLE class="userinfoArea" style=" margin:20px 0 0 0;" border="0" cellSpacing="0" cellPadding="0" width="100%">
        <THEAD>
          <TR>
            ...
            <TD><input type="input" class="px" id="keyword" value="" name="keyword" style="width:500px" >
              <br />
          ...
          <TR>
            ...
            <TD><label for="radio1">
                <input id="radio1" class="radio" type="radio" name="type" value="1"  checked="checked">
                完全匹配，用户输入的和此关键词一样才会触发!</label>
              <br />
              <label for="radio2">
                <input class="radio" id="radio2" type="radio" name="type" value="2">
                包含匹配 (只要用户输入的文字包含本关键词就触发!<span class="red">v2用户才生效</span>)</label></TD>
          </TR>
        </THEAD>
        <TBODY>
          <TR>
            <TH valign="top"><label for="text">内容或简介：</label></TH>
            <TD><textarea  class="px" id="Hfcontent" name="text" style="width:500px; height:150px"></textarea>
              <br />
              请不要多于1000字否则无法发送! </TD>
            <TD rowspan="2" valign="top"><div style="margin-left:20px" class="zdhuifu">
                ...
                <br>
                效果如下：<br>
                <img src="<?php echo RES;?>/images/chaolianjie.jpg" alt="文字超链接效果"> </div></TD>
          <TR>
            <TH></TH>
            <TD><button type="submit"  name="button"  class="btn btn-success left" >保存</button>
              <a href="<?php echo U('Img/add');?>"  class="btn btn-info"  >切换到图文模式</a>　<a href="index.php?ac=importtxt&amp;id=9379"  class="btn btn-info">取消</a>
