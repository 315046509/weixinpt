...
<div class="content" style="width:95%; background:none; margin-left:25px; border:none; margin-bottom:30px; margin-top:30px;" >
  ...
  <a href='<?php echo U('LuckyFruit/add',array('token'=>$token));?>' title='新增<?php echo ($lotteryTypeName); ?>活动' class='btn btn-primary'><img src="<?php echo RES;?>/images/img/activity-scratch-card.png" class="vm" />新增<?php echo ($lotteryTypeName); ?>活动</a>
              ...
              <TBODY>
                <TR></TR>
				  ...
				  <?php if($list['status'] == 0): ?><span class="red">未开始</span><?php else: ?><span class="green">已经开始</span><?php endif; ?>
				   ...
				   <a href="index.php?g=User&m=Lottery&a=sn&id=<?php echo ($list["id"]); ?>&type=4"><span class="btn btn-info btn-mini">SN码管理</span></a> 
				   <a href="index.php?g=User&m=LuckyFruit&a=edit&id=<?php echo ($list["id"]); ?>"><span class="btn btn-info btn-mini">编辑</span></a>  
				   <a class="btn btn-primary btn-mini" href="index.php?g=User&m=Lottery&a=cheat&id=<?php echo ($list["id"]); ?>">作弊</a> 
				   ...
				   <a class="btn btn-danger btn-mini" href="index.php?g=User&m=LuckyFruit&a=del&id=<?php echo ($list["id"]); ?>">删除</a></TD>
