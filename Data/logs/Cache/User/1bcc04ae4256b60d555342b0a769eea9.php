...
<div>
<ul class="changeapp">    
  <li><label> <input  type="checkbox" disabled="disabled" value="13"> 歌词接龙<a href="#"   class="vipimg vip-icon1" title=""></a></label><div>输入正确的歌词即可</div></li>
    
  <li>
	<label> <input  type="checkbox" disabled="disabled" value="19"> 今日桃花运指数<a href="#" class="vipimg vip-icon1" title=""></a></label>
	<div>桃花运+姓名例如<br> 杨广桃花运</div>
  </li>
    
  <li>
	<label> <input  type="checkbox" disabled="disabled"  value="24"> 历史上的今天<a href="#"   class="vipimg vip-icon1" title=""></a></label>
	<div>输入：today</div>
  </li>
    
  <li><label> <input  type="checkbox"       disabled="disabled"  value="26"> 爱情语录<a href="#"   class="vipimg vip-icon1" title=""></a></label><div>发一个爱的表情或者 输入一个爱</div></li>
    
  <li><label> <input  type="checkbox"       disabled="disabled"  value="27"> 人生格言<a href="#"   class="vipimg vip-icon1" title=""></a></label><div>随机看格言 输入格言二字;查询某位名人格言 ： 爱迪生格言</div></li>
    
  <li><label> <input  type="checkbox"       disabled="disabled"  value="31"> 号码百事通<a href="#"   class="vipimg vip-icon1" title=""></a></label><div>输入公司名称即可 例如：中国人寿电话</div></li>
    
  <li><label> <input  type="checkbox"       disabled="disabled"  value="34"> 健康食谱<a href="#"   class="vipimg vip-icon1" title=""></a></label><div></div></li>
    
  <li><label> <input  type="checkbox"       disabled="disabled"  value="35"> 泡妞秘诀<a href="#"   class="vipimg vip-icon1" title=""></a></label><div></div></li>
    
  <li><label> <input  type="checkbox"       disabled="disabled"  value="36"> 情书生成器<a href="#"   class="vipimg vip-icon1" title=""></a></label><div></div></li>
    
  <li><label> <input  type="checkbox"       disabled="disabled"  value="39"> 星座运势<a href="#"   class="vipimg vip-icon1" title=""></a></label><div></div></li>
    
  <li><label> <input  type="checkbox"       disabled="disabled"  value="40"> 安全期计算器<a href="#"   class="vipimg vip-icon1" title=""></a></label><div></div></li>
    
  <li><label> <input  type="checkbox"       disabled="disabled"  value="41"> 姓名配对<a href="#"   class="vipimg vip-icon1" title=""></a></label><div></div></li>
    
  <li><label> <input  type="checkbox"       disabled="disabled"  value="48"> 汽车知识库<a href="#"   class="vipimg vip-icon1" title=""></a></label><div></div></li>
    
  <li><label> <input  type="checkbox"       disabled="disabled"  value="49"> 手机知识库<a href="#"   class="vipimg vip-icon1" title=""></a></label><div></div></li>
    
  <li><label> <input  type="checkbox"       disabled="disabled"  value="50"> 驾考题库<a href="#"   class="vipimg vip-icon1" title=""></a></label><div></div></li>
    
  <li><label> <input  type="checkbox" disabled="disabled"  value="56"> 语音陪聊<a href="#"   class="vipimg vip-icon1" title=""></a></label><div></div></li>
    
  <li><label> <input  type="checkbox" disabled="disabled"  value="57"> 违章查询<a href="#"   class="vipimg vip-icon1" title=""></a></label><div>区域定制化模块</div></li>
    
  <li><label> <input  type="checkbox"  disabled="disabled"  value="59"> 汇率换算<a href="#"   class="vipimg vip-icon1" title=""></a></label><div></div></li>
   <li><label> <input  type="checkbox"  disabled="disabled"  value="59"> 一战到底<a href="#"   class="vipimg vip-icon3" title=""></a></label><div></div></li>
   <li><label> <input  type="checkbox"  disabled="disabled"  value="59"> 幸运水果机<a href="#"   class="vipimg vip-icon3" title=""></a></label><div></div></li>
   <li><label> <input  type="checkbox"  disabled="disabled"  value="59"> 数据魔方<a href="#"   class="vipimg vip-icon3" title=""></a></label><div>会员数据统计功能</div></li>
   <li><label> <input  type="checkbox"  disabled="disabled"  value="59"> 微客服系统<a href="#"   class="vipimg vip-icon3" title=""></a></label><div>微信在线客户系统</div></li>
      <div class="clr"></div>
   </ul>
</div>
