...
<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Greeting_card/add');?>" title="新增贺卡" class="btn btn-primary">新增贺卡</a> </div>
<div class="clr"></div>
</div>
<div class="msgWrap">
...
<?php if(is_array($greeting_card)): $i = 0; $__LIST__ = $greeting_card;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$greeting_card): $mod = ($i % 2 );++$i;?><tr>
	...
	<td class="norightborder">
		<a href="<?php echo U('Wap/Greeting_card/index',array('id'=>$greeting_card['id']));?>" target="_blank">查看</a>　
