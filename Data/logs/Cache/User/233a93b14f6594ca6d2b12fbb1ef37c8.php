...
<div class="content" style="width:95%; background:none; margin-left:25px; border:none; margin-bottom:30px; margin-top:30px;" >﻿  <div class="cLineB">
...
<h4 class="left">商城基本信息管理 (<?php echo ($page); ?>) </h4>
<div class="clr"></div>
</div>
<!--tab start-->
<div class="tab">
...
<li class="current tabli" id="tab2"><a href="<?php echo U('Product/shop_set',array('token'=>$token,'dining'=>0));?>">商城基本信息管理</a></li>
...
<input type="hidden" name="discount" id="discount" value="<?php echo ($set["discount"]); ?>" />
    <div class="msgWrap bgfc"> 
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody> 
            <tr> 
        <th><span class="red">*</span>店铺名称：</th> 
        <td><input type="text" name="shop_name" value="<?php echo ($set["shop_name"]); ?>" class="px" style="width:400px;" /></td> 
       </tr>  
        <tr> 
        <th><span class="red">*</span>头部图片：</th>
        <td><input type="text" name="head_bg" value="<?php echo ($set["head_bg"]); ?>" class="px" id="pic" style="width:400px;" />  <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic',700,700,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic')">预览</a></td> 
       </tr>  
      <tr> 
        <th><span class="red">*</span>头部描述：</th> 
        <td><input type="text" name="head_info" value="<?php echo ($set["head_info"]); ?>" class="px" style="width:400px;" /></td> 
       </tr>  
        <tr> 
        <th><span class="red">*</span>头像：</th>
        <td><input type="text" name="head_pic" value="<?php echo ($set["head_pic"]); ?>" class="px" id="pic2" style="width:400px;" />  <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic2',700,700,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('pic2')">预览</a></td> 
       </tr>
       <tr> 
        <th><span class="red">*</span>微信号：</th> 
        <td><input type="text" name="weixin_number" value="<?php echo ($set["weixin_number"]); ?>" class="px" style="width:400px;" /></td> 
       </tr> 
