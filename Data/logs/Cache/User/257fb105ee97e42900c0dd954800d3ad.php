...
﻿  <div class="cLineB">
   ...
   <h4>菜品分类设置</h4> 
    <a href="<?php echo U('Dining/cats',array('token'=>$token,'parentid'=>$parentid));?>" class="right  btn btn-info" style="margin-top:-27px">返回</a> 
   </div> 
     ...
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody> 
	   ...
	   <tr> 
        ...
        <td><select id="dicompanyid" name="dicompanyid" >
       ...
       <th>&nbsp;</th>
       <td>
       <button type="submit" name="button" class="btn btn-success">保存</button> &nbsp; <a href="<?php echo U('Dining/cats',array('token'=>$token));?>" class="btn btn-danger">取消</a></td> 
       </tr> 
      </tbody> 
     </table> 
     </div>
