...
<tr>
  ...
  <td><input type="input" class="px" id="keyword" value="" name="keyword" style="width:60px"> 非必填项，建议留空（留空保留原关注时回复的内容!）<br>
                   </td>
  <td>&nbsp;</td>
</tr>
                            </thead>
...
<tr>
  <th></th>
  <td><button type="submit" name="button" class="btn btn-success">添加</button> 
  </td>
  </tr>
  </tbody>
</table>
