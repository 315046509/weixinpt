...
<li class="<?php if($isBranch != 1): ?>current<?php endif; ?> tabli" id="tab2"><a href="<?php echo U('Company/index',array('token'=>$token));?>">公司信息</a></li>

<li class="tabli" id="tab2"><a href="<?php echo U('Company/branches',array('token'=>$token,'isBranch'=>1));?>">分支机构</a></li>

<li class="<?php if($isBranch == 1): ?>current<?php endif; ?> tabli" id="tab0"><a href="<?php echo U('Company/staff',array('token'=>$token,'isBranch'=>1));?>">商家密码设置</a></li>
...
<!--tab end-->
			...
			<a href="<?php echo U('Company/staffSet',array('token'=>$token,'id'=>$thisCard['id']));?>" title="" class="btnGrayS vm bigbtn">添加</a>　
