...
<div class="content" style="width:95%; background:none; margin-left:25px; border:none; margin-bottom:30px; margin-top:30px;" >
  <div class="cLineB">
    ...
    <ul class="quick-actions">
      <li class="bg_lb"> <a href="<?php echo U('ServiceUser/index',array('token'=>$token));?>"> <i class="icon-glass"></i> 人工客服 </a> </li>
      <li class="bg_ls"> <a href="<?php echo U('Message/index',array('token'=>$token));?>"> <i class="icon-envelope-alt"></i> 消息群发 </a> </li>
      <li class="bg_lv"> <a href="<?php echo U('Share/index',array('token'=>$token));?>"> <i class="icon-google-plus"></i> 分享设置 </a> </li>
      <li class="bg_dy"> <a href="<?php echo U('Recognition/index',array('token'=>$token));?>"> <i class="icon-star"></i> 渠道二维码</a> </li>
      <li class="bg_lg"> <a href="<?php echo U('Wechat_behavior/statistics',array('token'=>$token));?>"> <i class="icon-plus"></i> 行为分析</a> </li>
      <li class="bg_ly"> <a href="<?php echo U('Wechat_group/groups',array('token'=>$token));?>"> <i class="icon-tag"></i> 分组管理 </a> </li>
      <li class="bg_lo"> <a href="<?php echo U('Wechat_group/index',array('token'=>$token));?>"> <i class="icon-map-marker"></i> 粉丝管理 </a> </li>
...
<li>
  ...
  <tr>
        ...
        <td><input type="text" id="title" name="title" value="<?php echo ($info["title"]); ?>" class="px require" style="width:200px;" /> 仅发送视频的时候填写</td> 
              		...
              		<TR>
  <TH>媒体文件</TH>
  <TD><input type="input" class="px" id="media" name="mediasrc" style="width:250px"> <script src="/tpl/static/upyun.js"></script><a href="###" onclick="chooseFile('media','background')" class="ChooseImage">选择</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="upyunPicUpload('media',1500,1000,'<?php echo ($token); ?>')" class="ChooseImage">上传</a> 仅发送图片消息、语音消息或视频消息的时候填写</TD>
</TR>
<tr> 
...
<div style="clear:both"></div>
 ...
 <a href="###" onclick="addImgMessage()" class="ChooseImage">选择图文消息</a>&nbsp;&nbsp;<a style="display:none" href="###" onclick="clearMessage()" class="ChooseImage">清空重选</a>
...
<tr>
	<th></th>
	<td><button type="submit" name="button" class="btn btn-success">发送</button>　<a href="javascript:history.go(-1);" class="btn btn-danger">取消</a></td>
</tr>
 </tbody>
</table>
