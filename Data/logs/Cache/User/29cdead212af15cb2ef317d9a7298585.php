...
<?php if($type == 'hdbg'): ?><li class="current tabli" id="tab0"><a href="<?php echo U('Attachment/index',array('type'=>'hdbg'));?>">高清背景图</a></li><?php endif; ?>
...
<li class="tabli" id="tab0"><a href="<?php echo U('Attachment/index',array('type'=>'hdbg'));?>">高清背景图</a></li>
