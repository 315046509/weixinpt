	  ...
	  <form class="form" method="post" action="<?php echo U('Forum/set');?>" target="_top" enctype="multipart/form-data">	 
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
				...
				<tr>
					<th>回复图片：</th>
					<td><input type="text" name="picurl" id="picurl" value="<?php echo ($conf["picurl"]); ?>" class="px" style="width:550px;"><script src="/tpl/static/upyun.js"></script>  <a href="###" onclick="upyunPicUpload('picurl',360,200,'<?php echo ($token); ?>')" class="ChooseImage">上传</a> <a href="###" onclick="viewImg('picurl')" class="ChooseImage">预览</a><br/> </td>
				</tr>
				
				<tr>
					<th>讨论社区Logo：</th>
					<td><input type="text" name="logo" id="logo" value="<?php echo ($conf["logo"]); ?>" class="px" style="width:550px;">  <a href="###" onclick="upyunPicUpload('logo',1500,1000,'<?php echo ($token); ?>')" class="ChooseImage">上传</a> <a href="###" onclick="viewImg('logo')" class="ChooseImage">预览</a><br/> </td>
				</tr>				
				<tr>
					<th>自定义背景</th>
					<td><input type="text" name="bgurl" id="bgurl" value="<?php echo ($conf["bgurl"]); ?>" class="px" style="width:550px;">  <a href="###" onclick="upyunPicUpload('bgurl',1500,1000,'<?php echo ($token); ?>')" class="ChooseImage">上传</a> <a href="###" onclick="viewImg('bgurl')" class="ChooseImage">预览</a><br/> </td>
				</tr>
				<tr>
