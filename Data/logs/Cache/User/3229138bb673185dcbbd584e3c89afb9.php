...
﻿  <div class="cLine">
  ...
  <a href='<?php echo U("Voiceresponse/add");?>' title='新增语音回复' class='btn btn-primary'><img src="<?php echo RES;?>/images/music.png" class="vm" />新增语音回复</a>
            </div>
...
删除
          ...
          <a href="JavaScript:void(0);" class="btn btn-successs" onclick="if(confirm('您确定操作吗?')){checkvotethis();}"><span>确定</span></a>
</td>
                </tr>
              </TBODY>
            </TABLE>
