...
<!--tab end-->
<div class="pageNavigator"> <a href="<?php echo U('Hotels/add',array('token' => $token,'cid'=>$cid));?>" title="添加" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加房间类型</a></div>
<div class="clr"></div>
<div class="msgWrap">
