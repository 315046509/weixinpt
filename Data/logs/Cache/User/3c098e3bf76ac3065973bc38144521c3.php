...
<div class="content" style="width:95%; background:none; margin-left:25px; border:none; margin-bottom:30px; margin-top:10px;" >﻿  <div class="cLineB">
    ...
    <h4>团购设置</h4> 
    <a href="<?php echo U('Groupon/products',array('token'=>$token));?>" class="right  btn btn-info" style="margin-top:-27px">返回</a> 
   </div> 
    ...
    <div class="msgWrap bgfc"> 
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      ...
      <input type="hidden" name="groupon" value="1" />
       <button type="submit" name="button" class="btn btn-success">保存</button> &nbsp; <a href="<?php echo U('Groupon/products',array('token'=>$token));?>" class="btn btn-danger">取消</a></td> 
       </tr> 
      </tbody> 
     </table> 
     </div>
