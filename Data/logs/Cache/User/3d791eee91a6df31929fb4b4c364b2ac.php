...
<h4 class="left">无线打印</h4>
<div class="clr"></div>
</div>
<div class="cLine">
<div class="pageNavigator left">
<p style="color:gray;">
打印机填写URL：<?php echo U('Home/Printer/index','',true,false,true);?><br />
打印机测试：<?php echo U('Home/Printer/preview','',true,false,true);?>
</p>
<a href="<?php echo U('Printer/set');?>" title="添加" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加打印机</a>
</div>
<div class="clr"></div>
</div>
<div class="msgWrap">
...
<td><?php echo (htmlspecialchars($vo['sn'])); ?></td>
<td><?php echo (date("Y-m-d H:i:s",$vo["create_time"])); ?></td> 
<td><a href="<?php echo U('Printer/set',array('id'=>$vo['id']));?>">修改</a>　<a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Printer/del',array('id'=>$vo['id']));?>');">删除</a></td>
