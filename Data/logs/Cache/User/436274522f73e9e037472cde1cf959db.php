...
<?php if($es_data['id'] != ''): ?><input type="hidden" name="id" value="<?php echo ($es_data['id']); ?>" /><?php endif; ?>
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name="title" id="title" maxlength="10" class="px" value="<?php echo ($es_data['title']); ?>" data-rule-required="true"><span class="maroon">*</span><span class="help-inline">触发关键词后返回图文消息标题</span>
		</div>
	</div>
	<div class="control-group">
		<label for="keyword" class="control-label">触发关键词：</label>
		<div class="controls">
			<input type="text" name="keyword" id="keyword" class="px" data-rule-required="true" value="<?php echo ($es_data['keyword']); ?>"><span class="maroon">*</span><span class="help-inline">只能设置一个关键字</span>
		</div>
	</div>
  <div class="control-group">
    <label for="coverurl" class="control-label">图文消息封面：</label>
    <div class="controls">
      <img class="thumb_img" id="cover_src" src="<?php echo (($es_data['cover'])?($es_data['cover']):'./tpl/static/vhouse/138wo02.jpg'); ?>" style="max-height:100px;">
      <input type="input" class="px" id="cover" value="<?php echo (($es_data['cover'])?($es_data['cover']):'./tpl/static/vhouse/138wo02.jpg'); ?>" name="cover" >
                                     
          <span class="help-inline">
               <script src="<?php echo STATICS;?>/upyun.js"></script><a href="###" onclick="upyunPicUpload('cover',720,400,'<?php echo ($token); ?>')" class="ChooseImage">上传</a> <a href="###" onclick="viewImg('cover')" class="ChooseImage">预览</a>
	...
	<div class="control-group">
         <label class="control-label">楼盘头部图片：</label>
                                    <div class="controls">
                                        <img class="thumb_img" id="banner_src" src="<?php echo (($es_data['banner'])?($es_data['banner']):'./tpl/static/vhouse/138wo01.jpg'); ?>" style="max-height:50px;_height:50px;overflow:auto;""> 
                                            <input type="text" id="banner" name="banner" class="px" value="<?php echo (($es_data['banner'])?($es_data['banner']):'./tpl/static/vhouse/138wo01.jpg'); ?>"> 
                                            <span class="help-inline">  
                                            <a href="###" onclick="upyunPicUpload('banner',720,400,'<?php echo ($token); ?>')" class="ChooseImage">上传</a> <a href="###" onclick="viewImg('banner')" class="ChooseImage">预览</a>                          
		...
		<div class="control-group">
                                    ...
                                    <div class="controls">
                                        <img class="thumb_img" id="house_banner_src" src="<?php echo (($es_data['house_banner'])?($es_data['house_banner']):'./tpl/static/vhouse/138wo32.jpg'); ?>" style="max-height:50px;_height:50px;overflow:auto;"">
                                        <input type="text" name="house_banner" id="house_banner" class="px" value="<?php echo (($es_data['house_banner'])?($es_data['house_banner']):'./tpl/static/vhouse/138wo32.jpg'); ?>">
                                        <span class="help-inline">
                                             <script src="<?php echo STATICS;?>/upyun.js"></script><a href="###" onclick="upyunPicUpload('house_banner',720,400,'<?php echo ($token); ?>')" class="ChooseImage">上传</a> <a href="###" onclick="viewImg('house_banner')" class="ChooseImage">预览</a>
                                            <span class="help-inline">建议尺寸：宽720像素，高350像素</span>
                                        </span>
                                    </div>
                                </div>
	    ...
	    <div class="control-group">
		<div class="control-group">
                                    <label class="control-label">首页幻灯照片1：</label>
                                    <div class="controls">
                                        <img class="thumb_img" id="house_banner_src" src="<?php echo (($es_data['banner1'])?($es_data['banner1']):'./tpl/static/vhouse/138wo1.jpg'); ?>" style="max-height:50px;_height:50px;overflow:auto;"">
                                        <input type="text" name="banner1" id="banner1" class="px" value="<?php echo (($es_data['banner1'])?($es_data['banner1']):'./tpl/static/vhouse/138wo1.jpg'); ?>">
                                        <span class="help-inline">
                                             <script src="<?php echo STATICS;?>/upyun.js"></script><a href="###" onclick="upyunPicUpload('banner1',720,400,'<?php echo ($token); ?>')" class="ChooseImage">上传</a> <a href="###" onclick="viewImg('banner1')" class="ChooseImage">预览</a>
                                            <span class="help-inline">建议尺寸：宽720像素，高1280像素</span>
                                        </span>
                                    </div>
                                </div>
	</div>
	    <div class="control-group">
		<div class="control-group">
                                    <label class="control-label">首页幻灯照片2：</label>
                                    <div class="controls">
                                        <img class="thumb_img" id="house_banner_src" src="<?php echo (($es_data['banner2'])?($es_data['banner2']):'./tpl/static/vhouse/138wo2.jpg'); ?>" style="max-height:50px;_height:50px;overflow:auto;"">
                                        <input type="text" name="banner2" id="banner2" class="px" value="<?php echo (($es_data['banner2'])?($es_data['banner2']):'./tpl/static/vhouse/138wo2.jpg'); ?>">
                                        <span class="help-inline">
                                             <script src="<?php echo STATICS;?>/upyun.js"></script><a href="###" onclick="upyunPicUpload('banner2',720,400,'<?php echo ($token); ?>')" class="ChooseImage">上传</a> <a href="###" onclick="viewImg('banner2')" class="ChooseImage">预览</a>
                                            <span class="help-inline">建议尺寸：宽720像素，高1280像素</span>
                                        </span>
                                    </div>
                                </div>
	    ...
	    <div class="control-group">
		<div class="control-group">
                                    <label class="control-label">首页幻灯照片3：</label>
                                    <div class="controls">
                                        <img class="thumb_img" id="house_banner_src" src="<?php echo (($es_data['banner3'])?($es_data['banner3']):'./tpl/static/vhouse/138wo3.jpg'); ?>" style="max-height:50px;_height:50px;overflow:auto;"">
                                        <input type="text" name="banner3" id="banner3" class="px" value="<?php echo (($es_data['banner3'])?($es_data['banner3']):'./tpl/static/vhouse/138wo3.jpg'); ?>">
                                        <span class="help-inline">
                                             <script src="<?php echo STATICS;?>/upyun.js"></script><a href="###" onclick="upyunPicUpload('banner3',720,400,'<?php echo ($token); ?>')" class="ChooseImage">上传</a> <a href="###" onclick="viewImg('banner3')" class="ChooseImage">预览</a>
                                            <span class="help-inline">建议尺寸：宽720像素，高1280像素</span>
                                        </span>
                                    </div>
                                </div>
	    ...
	    <div class="control-group">
		<div class="control-group">
                                    <label class="control-label">首页幻灯照片4：</label>
                                    <div class="controls">
                                        <img class="thumb_img" id="house_banner_src" src="<?php echo (($es_data['banner4'])?($es_data['banner4']):'./tpl/static/vhouse/138wo4.jpg'); ?>" style="max-height:50px;_height:50px;overflow:auto;"">
                                        <input type="text" name="banner4" id="banner4" class="px" value="<?php echo (($es_data['banner4'])?($es_data['banner4']):'./tpl/static/vhouse/138wo4.jpg'); ?>">
                                        <span class="help-inline">
                                             <script src="<?php echo STATICS;?>/upyun.js"></script><a href="###" onclick="upyunPicUpload('banner4',720,400,'<?php echo ($token); ?>')" class="ChooseImage">上传</a> <a href="###" onclick="viewImg('banner4')" class="ChooseImage">预览</a>
                                            <span class="help-inline">建议尺寸：宽720像素，高1280像素</span>
                                        </span>
                                    </div>
                                </div>
	    ...
	    <div class="control-group">
		<div class="control-group">
                                    <label class="control-label">首页幻灯照片5：</label>
                                    <div class="controls">
                                        <img class="thumb_img" id="house_banner_src" src="<?php echo (($es_data['banner5'])?($es_data['banner5']):'./tpl/static/vhouse/138wo5.jpg'); ?>" style="max-height:50px;_height:50px;overflow:auto;"">
                                        <input type="text" name="banner5" id="banner5" class="px" value="<?php echo (($es_data['banner5'])?($es_data['banner5']):'./tpl/static/vhouse/138wo5.jpg'); ?>">
                                        <span class="help-inline">
                                             <script src="<?php echo STATICS;?>/upyun.js"></script><a href="###" onclick="upyunPicUpload('banner5',720,400,'<?php echo ($token); ?>')" class="ChooseImage">上传</a> <a href="###" onclick="viewImg('banner5')" class="ChooseImage">预览</a>
                                            <span class="help-inline">建议尺寸：宽720像素，高1280像素</span>
                                        </span>
                                    </div>
                                </div>
...
<div class="control-group">
    ...
    <label for="suggestId" class="control-label">地图标识：</label>
         <div class="controls">
         经度 <input type="text" id="longitude"  name="lng" size="14" class="px" value="<?php echo ($es_data['lng']); ?>" /> 纬度 <input type="text"  name="lat" size="14" id="latitude" class="px" value="<?php echo ($es_data['lat']); ?>" /> <a href="###" onclick="setlatlng($('#longitude').val(),$('#latitude').val())" class="ChooseImage">在地图中查看/设置</a>
         </div>
    </div>
<div class="control-group">
 ...
 <?php if($es_data['id'] != ''): ?><input type="hidden" name="id" value="<?php echo ($es_data['id']); ?>" /><?php endif; ?>
   <div class="form-actions">
			<button id="bsubmit" type="submit" data-loading-text="提交中..." class="btn btn-success">保存</button>　<button type="button" class="btn btn-info">取消</button>
		</div>
</form>
  </div> 
        </div>
