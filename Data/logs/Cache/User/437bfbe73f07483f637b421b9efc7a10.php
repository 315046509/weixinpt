  ...
  <div  class="quick-actions_homepage">
    ...
    <ul class="quick-actions">
      ...
      <li class="bg_lh"> <a href="/index.php?g=User&m=Member_card&a=staff&token=<?php echo ($token); ?>&id=<?php echo ($thisCard["id"]); ?>"> <i class="icon-globe"></i> 管理员设置</a> </li>
          ...
          <h4><?php echo ($thisCard["cardname"]); ?>：商家开卡配置 <span class="FAQ">卡号自定义啦</span> <strong>本月可创建 <span style="color:red"><?php echo ($count); ?></span> 张，剩余<span style="color:red"><?php echo ($cancrnum); ?></span>张</strong></h4><a href="javascript:history.go(-1);" class="right btn btn-info" style="margin-top:-27px">返回</a></div>
...
<tr>
	...
	<td><button type="submit" id="button" name="button" class="btn btn-success">保存</button>　<a href="javascript:history.go(-1);" class="btn btn-info">取消</a></td>
