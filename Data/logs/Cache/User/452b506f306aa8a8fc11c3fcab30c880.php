  ...
  <div  class="quick-actions_homepage">
    <ul class="quick-actions">
      ...
      <li class="bg_lh"> <a href="<?php echo U('Other/index',array('token'=>$token));?>" target="_blank"> <i class="icon-book"></i> 回答不上</a> </li>
          ...
          <h4>编辑语音回复</h4><a href="javascript:history.go(-1);"  class="right btn btn-info" style="margin-top:-27px" >返回</a></div> 
<div class="msgWrap">
...
<TR>
  ...
  <TD><input type="input" class="px" id="MusicUrl" value="" name="musicurl" style="width:600px" > <script src="/tpl/static/upyun.js?2013"></script><a href="###" onclick="upyunPicUpload('musicurl',0,0,'{pigcms:$token}')" class="ChooseImage">上传</a>&nbsp;<a href="###" onclick="chooseFile('musicurl','music')" class="ChooseImage">选择</a><br />
                  </TD>
</TR>
                            <TR>
  <TH valign="top"><span class="red">*</span><label for="HQMusicUrl">高品质音乐链接：</label></TH>
  <TD><input type="input" class="px" id="HQMusicUrl" value="" name="hqmusicurl" style="width:600px" > <a href="###" onclick="upyunPicUpload('HQMusicUrl',0,0,'{pigcms:$token}')" class="ChooseImage">上传</a>&nbsp;<a href="###" onclick="chooseFile('HQMusicUrl','music')" class="ChooseImage">选择</a><br />没有高品质音乐链接，请直接再填一遍音乐链接。（高质量音乐链接，WIFI环境优先使用该链接播放音乐）
                  </TD>
</TR>
  </THEAD>
  <TBODY>
...
<TR>
  <TH></TH>
  <TD><button type="submit"  name="button"  class="btn btn-success left" >保存</button>　<a href="index.php?ac=mp3list&amp;id=9379"  class="btn btn-info">取消</a>
  <div class="clr"></div>
</TD>
</TR>
  </TBODY>
