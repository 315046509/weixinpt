...
<li class="current tabli" id="tab2"><a href="<?php echo U('Dining/tables',array('token'=>$token,'dining'=>1));?>">桌台管理</a></li>
...
<div class="pageNavigator"> <a href="<?php echo U('Dining/tableAdd',array('token'=>$token,'dining'=>$isDining));?>" title="" class="btn btn-primary"><img src="<?php echo RES;?>/images/product/add.png" class="vm">添加桌台</a></div>
<div class="clr"></div>
...
<td class="norightborder"><a href="<?php echo U('Dining/tableSet',array('token'=>$token,'id'=>$o['id'],'dining'=>1));?>">修改</a> <a href="javascript:drop_confirm('您确定要删除吗?', '<?php echo U('Dining/tableDel',array('token'=>$token,'id'=>$o['id'],'dining'=>1));?>');">删除</a></td>
