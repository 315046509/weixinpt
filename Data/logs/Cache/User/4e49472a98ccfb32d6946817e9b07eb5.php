    ...
    <ul class="quick-actions">
      ...
      <li class="bg_db"> <a href="javascript:history.go(-1);"> <i class="icon-share-alt"></i> 返回</a> </li>
          ...
          <div class="cLine">
			...
			<a href='/index.php?g=User&m=Lottery&a=add' title='新增幸运大转盘活动' class='btn btn-primary'><img src="<?php echo RES;?>/images/img/activity-lottery.png" class="vm" />新增幸运大转盘活动</a>
              ...
              <TBODY>
                <TR></TR>
                  ...
                  <TD>大转盘 <?php echo ($list["id"]); ?></TD>
				   ...
				   <a href="index.php?g=User&m=Lottery&a=sn&id=<?php echo ($list["id"]); ?>"><span class="btn btn-info btn-mini">SN码管理</span></a> 
				   <a href="index.php?g=User&m=Lottery&a=cheat&id=<?php echo ($list["id"]); ?>"><span class="btn btn-info btn-mini">作弊</span></a> 
				   <a class="btn btn-primary btn-mini" href="index.php?g=User&m=Lottery&a=edit&id=<?php echo ($list["id"]); ?>">编辑</a>  
				   <a class="btn btn-success btn-mini" href="<?php if($list['status'] == 1): ?>javascript:drop_confirm('你确定要结束活动吗，结束后不可再开启本活动!', 'index.php?g=User&m=Lottery&a=endLottery&id=<?php echo ($list["id"]); ?>');<?php else: ?>index.php?g=User&m=Lottery&a=startLottery&id=<?php echo ($list["id"]); endif; ?>">
				   <?php if($list['status'] == 0): ?>开始<?php else: ?>结束<?php endif; ?>				   
				   </a>
				  
				   <a class="btn btn-danger btn-mini" href="index.php?g=User&m=Lottery&a=del&id=<?php echo ($list["id"]); ?>">删除</a></TD>
