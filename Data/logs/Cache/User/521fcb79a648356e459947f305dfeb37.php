              ...
              <TBODY>
               <TR>
                ...
                <TR style="display:none">
                  ...
                  <TD><input class="px"  name="pic" id="pic" value="" style="width:580px;"  />  <script src="/tpl/static/upyun.js?2013"></script><a href="###" onclick="upyunPicUpload('pic',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a> <a href="###" onclick="viewImg('pic')" class="ChooseImage">预览</a>
</TD>
                </TR>
               <TR>
                ...
                <TR>
                  ...
                  <TD><script id="editor" name="info" type="text/plain" style="width:590px;height:360px;"><?php echo ($set["info"]); ?></script></TD>
                </TR>  
                 <TR>
