      ...
      <li class="bg_db"> <a href="javascript:history.go(-1);"> <i class="icon-share-alt"></i> 返回</a> </li>
          ...
          <div class="cLine">
            <div class="pageNavigator left">
				<a href="<?php echo U('Api/add');?>" title="新增接口" class="btn btn-primary"><img src="/tpl/User/default/common/images/api.png" class="vm">新增接口</a>　
			  ...
			  <?php if(is_array($api)): $i = 0; $__LIST__ = $api;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$api): $mod = ($i % 2 );++$i;?><tr>
                ...
                <tr>
					<td colspan="7" class="edit norightborder"> 
						...
						<a  class="btn btn-successs" ><span>确定</span></a>
					</td>
                </tr>
              </tbody>
            </table>
