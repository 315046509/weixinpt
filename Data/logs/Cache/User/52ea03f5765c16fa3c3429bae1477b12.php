...
<div class="tab">
<ul>
<li class="<?php if(ACTION_NAME == 'index'): ?>current<?php endif; ?> tabli" id="tab0"><a href="<?php echo U('Zhengwu/index',array('token'=>$token));?>">政务部门介绍</a></li>
<li class="<?php if(ACTION_NAME == 'son' ): ?>current<?php endif; ?> tabli" id="tab2"><a href="<?php echo U('Zhengwu/son',array('token'=>$token));?>">服务窗口</a></li>
<li class="<?php if(ACTION_NAME == 'housetype' ): ?>current<?php endif; ?> tabli" id="tab2"><a href="<?php echo U('Zhengwu/housetype',array('token'=>$token));?>">服务类型</a></li>
<li class="<?php if(ACTION_NAME == 'album' or ACTION_NAME == 'album_add'): ?>current<?php endif; ?> tabli" id="tab5"><a href="<?php echo U('Zhengwu/album',array('token'=>$token));?>">政务相册</a></li>
<li class="<?php if(ACTION_NAME == 'expert'): ?>current<?php endif; ?> tabli" id="tab5"><a href="<?php echo U('Zhengwu/expert',array('token'=>$token));?>">市民印象点评</a></li>
<li class="<?php if(ACTION_NAME == 'zhengwuindex'): ?>current<?php endif; ?> tabli" id="tab6"><a href="<?php echo U('Reservation/zhengwuindex',array('token'=>$token));?>">预约管理</a></li>
</ul>
</div>
  ...
  <input type="hidden" name="thetype" value="Zhengwu">
<?php if($es_data['id'] != ''): ?><input type="hidden" name="id" value="<?php echo ($es_data['id']); ?>" /><?php endif; ?>
	...
	<div class="control-group">
		...
		<div class="controls">
      <img class="thumb_img" id="cover_src" src="<?php echo (($es_data['cover'])?($es_data['cover']):'./tpl/static/sucai/Zhengwu/1.jpg'); ?>" style="max-height:100px;">
     <input type="text" name="cover" value="<?php echo (($es_data['cover'])?($es_data['cover']):'./tpl/static/sucai/Zhengwu/1.jpg'); ?>" id="cover" class="px" style="width:150px;" ><script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('cover',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a> 
	...
	<div class="control-group">
         <label class="control-label">政务部门顶部图片：</label>
                                    <div class="controls">
                                        <img class="thumb_img" id="banner_src" src="<?php echo (($es_data['banner'])?($es_data['banner']):'./tpl/static/sucai/Zhengwu/2.png'); ?>" style="max-height:100px;"> 
                                        
                                            <input type="text" id="banner" name="banner" class="px" value="<?php echo (($es_data['banner'])?($es_data['banner']):'./tpl/static/sucai/Zhengwu/2.png'); ?>"><script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('banner',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
	...
	<div class="control-group">
		<div class="control-group">
                                    ...
                                    <div class="controls">
                                        <img class="thumb_img" id="house_banner_src" src="<?php echo (($es_data['house_banner'])?($es_data['house_banner']):'./tpl/static/sucai/Zhengwu/4.png'); ?>" style="max-height:100px;">
                                        <input type="text" name="house_banner" id="house_banner" class="px" value="<?php echo (($es_data['house_banner'])?($es_data['house_banner']):'./tpl/static/sucai/Zhengwu/4.png'); ?>"><script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('house_banner',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
	...
	<div class="control-group">
                                ...
                                <div class="control-group">
                                    <label class="control-label">公开政务信息：</label>
                                    <div class="controls">
...
<div class="control-group">
		<label for="place" class="control-label">政务部门地址：</label>
		<div class="controls"> 
...
<div class="control-group">
     ...
     <div class="control-group">
         <label for="project_brief" class="control-label">政务部门简介：</label>
         <div class="controls">
