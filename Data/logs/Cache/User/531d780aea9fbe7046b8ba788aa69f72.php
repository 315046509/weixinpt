...
<h4>添加底部菜单</h4><a href="javascript:history.go(-1);"  class="right btn btn-info" style="margin-top:-27px" >返回</a></div> 
<div class="msgWrap">
...
<TR>
  ...
  <TD><input type="input" class="px" id="img" value="" name="picurl" id="img" style="width:500px" >  <script src="/tpl/static/upyun.js?2013"></script><a href="###" onclick="chooseFile('img','icon')" class="ChooseImage">选择</a> <a href="###" onclick="upyunPicUpload('img',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a> <a href="###" onclick="viewImg('img')" class="ChooseImage">预览</a>
  <br/>
  <div style="margin:10px 0">您可以点击下面这些图片作为图标（直接点击即可）</div>
  <div style="background:#000;width:570px;margin:10px 0;text-align:center">
  <?php
 for ($i=1;$i<247;$i++){ echo '<img onclick="document.getElementById(\'img\').value=this.src" style="width:30px;cursor:pointer;" src="tpl/User/default/common/images/photo/plugmenu'.$i.'.png" />'; } ?>
  </div>
  </TD>
  <TD>&nbsp;</TD>
</TR>
<TR>
  ...
  <TD><input type="input" class="px" id="url" value="" name="url" style="width:500px" >   <a href="###" onclick="addLink('url',0)" class="ChooseImage">从功能库添加</a><br />
