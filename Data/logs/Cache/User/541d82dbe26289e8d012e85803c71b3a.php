...
<div class="cLineB">
    ...
    <a href="<?php echo U('Diaoyan/index',array('token'=>$token));?>" class="right  btn btn-success" style="margin-top:-27px">返回</a> 
     ...
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      ...
      <tbody> 
	   ...
	   <tr> 
        ...
        <td><input type="text" id="small_pic" name="pic" value="<?php echo ($set["pic"]); ?>" class="px require" style="width:400px;" /> <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('small_pic',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a> <a href="###" onclick="viewImg('small_pic')" class="ChooseImage">预览</a></td> 
		...
		<TR>
			...
			<td><input type="input" class="px" id="statdate" value="<?php if($set['stime'] != ''): echo ($set["stime"]); else: echo date('Y-m-d',mktime(0, 0, 0, date("m") , date("d"), date("Y"))); endif; ?>" onClick="WdatePicker()" name="stime" />                

			到

			<input type="input" class="px" id="enddate" value="<?php if($set['etime'] != ''): echo ($set["etime"]); else: echo date('Y-m-d',mktime(0, 0, 0, date("m") , date("d")+3, date("Y"))); endif; ?>" name="etime" onClick="WdatePicker()"  /> 
        ...
        <TR>
            ...
            <TD><textarea name="sinfo" id="content1"  rows="5" style="width:490px;height:360px"><?php echo ($set["sinfo"]); ?></textarea></TD>
		...
		<TR>
            ...
            <TD><textarea name="einfo" id="content2"  rows="5" style="width:490px;height:360px"><?php echo ($set["einfo"]); ?></textarea></TD>
       ...
       <button type="submit" class="btn btn-success">保存</button> &nbsp; <a href="<?php echo U('Diaoyan/add',array('token'=>$token));?>" class="btn btn-info">取消</a></td> 
