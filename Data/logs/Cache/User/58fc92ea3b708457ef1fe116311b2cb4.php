...
﻿  <div class="cLineB">
    ...
    <h4>桌台设置</h4> 
    <a href="<?php echo U('Dining/tables',array('token'=>$token,'dining'=>$isDining));?>" class="right  btn btn-info" style="margin-top:-27px">返回</a> 
   </div> 
    ...
    <div class="msgWrap bgfc" style="width:920p"> 
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      ...
      <tr> 
       ...
       <button type="submit" name="button" class="btn btn-success">保存</button> &nbsp; <a href="<?php echo U('Dining/tables',array('token'=>$token));?>" class="btn btn-danger">取消</a></td> 
       </tr> 
      </tbody> 
     </table> 
     </div>
