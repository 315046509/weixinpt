...
<div class="content" style="width:98%; background:none; margin-left:15px; border:none; margin-bottom:30px;" >
	 <div class="cLineB">
		<h4>商家设置 </h4><a href="index.php?ac=card-list&amp;id=9878" class="right btn btn-info" style="margin-top:-27px">返回</a>
	 </div>  
			...
			<tbody>
				<tr>
					...
					<td valign="top">商家logo外链地址(图片尺寸100x100)<br>
						<input type="input" class="px" id="clogo" name="clogo" value="<?php echo ($info["clogo"]); ?>" style="width:250px;" onblur="document.getElementById('clogo_src').src=document.getElementById('clogo').value;"><script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('clogo',1000,600,'<?php echo ($token); ?>')" class="a_upload">上传</a> <a href="###" onclick="viewImg('clogo')">预览</a>
					</td>
					<td rowspan="4" valign="top">&nbsp;</td>
					<td rowspan="4" valign="top"><img id="logo_src" class="logo" src="<?php echo ($info["clogo"]); ?>" width="100px" height="100px"></td>
				</tr>
				<tr>
			 ...
			 <tr>
				<td colspan="5" class="norightborder">
					<button type="submit" name="batchsubmit" value="true" class="btn btn-success vm"><strong>保存</strong></button>
				</td>
			 </tr>
		</tbody>
			</tbody>
	 ...
	 <form action="<?php echo U('Member_card/Contact');?>" method="post">  
		...
		<tbody>
			<tr>
				...
				<td class="norightborder"><button type="submit" class="btn btn-info"><strong>添加</strong></button></td>
			</tr>
		 </tbody>
		 	<tbody>
			<tr>
		...
		<?php if(is_array($contact)): $i = 0; $__LIST__ = $contact;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$contact): $mod = ($i % 2 );++$i;?><tbody>
				...
				<tr>
					...
					<td class="norightborder"><button type="submit" class="btn btn-success vm"><strong>修改</strong></button></td>
				</tr>
				</form>
