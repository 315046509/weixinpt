...
<div class="content" style="width:95%; background:none; margin-left:25px; border:none; margin-bottom:30px; margin-top:10px;" >﻿  <div class="cLineB">
    ...
    <a href="<?php echo U('Host/index',array('token'=>$token));?>" class="right  btn btn-success" style="margin-top:-27px">返回</a> 
     ...
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      ...
      <tbody> 
       ...
       <tr> 
        ...
        <td><input type="text" name="ppicurl" id="pic" value="<?php echo ($set["ppicurl"]); ?>"  class="px require" style="width:400px;" readonly="readonly"/><script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a> <a href="###" onclick="viewImg('pic')" class="ChooseImage">预览</a></td> 
       ...
       <tr>         
        ...
        <td>&nbsp;</td> <td>&nbsp;</td> <td>&nbsp;</td> <td>&nbsp;</td>  <td><button type="submit" name="button" class="btn btn-success">保存</button> | <a href="<?php echo U('Host/index',array('token'=>$token));?>" class="btn btn-info">取消</a></td> 
