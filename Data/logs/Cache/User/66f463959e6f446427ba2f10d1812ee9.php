...
<td><span class="<?php echo ($vo["icon"]); ?>"></span></td>
...
<td align="center"><?php if(($vo["status"]) == "1"): ?>显示<?php else: ?>不显示<?php endif; ?></td>
<td class="norightborder">
	<!--a target="ddd" href="<?php echo U('Wap/Index/classify',array('token'=>$_SESSION['token']));?>">查看</a-->
	<a style="color:blue" href="<?php echo U('Classify/index',array('fid'=>$vo['id']));?>">子分类</a>
	...
	<a style="color:red" href="<?php if ($vo['fid']==0){ echo U('Classify/del',array('id'=>$vo['id'])); }else{ echo U('Classify/del',array('id'=>$vo['id'],'fid'=>$vo['fid'])); }?>">删除</a>
</td>
