    ...
    <ul class="quick-actions">
      ...
      <li class="bg_db"> <a href="javascript:history.go(-1);"> <i class="icon-share-alt"></i> 返回</a> </li>
              ...
              <h4 class="left">设备列表</h4>
                  ...
                  <input type="submit" value="搜索" id="msgSearchBtn" href="javascript:;" class="btn btn-info" title="搜索">
                  </form>
                  </div>
              <div class="clr"></div>
          </div>
          <div class="cLine">
            <div class="pageNavigator left">
				<a href="<?php echo U('AP/add');?>" title="新增设备" class="btn btn-primary">新增设备</a>　
			  ...
			  <?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$o): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td><?php echo ($o["mac"]); ?></td>
                   <td><?php echo ($o["addr"]); ?></td>
                    ...
                    <td><?php if($o['deploy_status'] == 1): ?>已连通<?php else: ?><i style='color:#cccccc'>未连通</i><?php endif; ?></td>
                   <td class="norightborder"> 
					
					<a class="btn btn-primary btn-mini" href="<?php echo U('AP/add',array('id'=>$o['id']));?>" title="">编辑</a> 
					<a class="btn btn-danger btn-mini" href="<?php echo U('AP/delete',array('id'=>$o['id']));?>">删除</a></td>
