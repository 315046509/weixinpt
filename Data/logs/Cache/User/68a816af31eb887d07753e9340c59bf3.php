...
<h4>微信墙设置</h4><a href="javascript:history.go(-1);"  class="right btn btn-info" style="margin-top:-27px" >返回</a></div> 
<div class="msgWrap">
...
<TR>
  ...
  <TD><input type="input" class="px" id="logo" value="<?php echo ($info["logo"]); ?>" name="logo" style="width:250px" value="" >  <a href="###" onclick="chooseFile('logo','my')" class="ChooseImage">选择</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="upyunPicUpload('logo',400,400,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="viewImg('logo')" class="ChooseImage">预览</a> 标题前面的logo,高度最佳80px，宽度最佳不超过200px，可以不填写
</TD>
</TR>

<TR>
  <TH valign="top"><label for="text">开幕背景：</label></TH>
  <TD><input type="input" class="px" id="startbackground" value="<?php echo ($info["startbackground"]); ?>" name="startbackground" style="width:250px" value="<?php echo ($info["startbackground"]); ?>" > <script src="/tpl/static/upyun.js"></script><a href="###" onclick="chooseFile('startbackground','background')" class="ChooseImage">选择</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="upyunPicUpload('startbackground',1500,1000,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="viewImg('startbackground')" class="ChooseImage">预览</a> 最佳尺寸宽984px,高636px
</TD>
</TR>
<TR>
  <TH valign="top"><label for="text">背景：</label></TH>
  <TD><input type="input" class="px" id="background" value="<?php echo ($info["background"]); ?>" name="background" style="width:250px" value="<?php echo ($info["background"]); ?>" > <script src="/tpl/static/upyun.js"></script><a href="###" onclick="chooseFile('background','background')" class="ChooseImage">选择</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="upyunPicUpload('background',1500,1000,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="viewImg('background')" class="ChooseImage">预览</a>  默认为空会有更好的显示效果
</TD>
</TR>
<TR>
  <TH valign="top"><label for="text">结束背景：</label></TH>
  <TD><input type="input" class="px" id="endbackground" value="<?php echo ($info["endbackground"]); ?>" name="endbackground" style="width:250px" value="<?php echo ($info["endbackground"]); ?>" > <script src="/tpl/static/upyun.js"></script><a href="###" onclick="chooseFile('endbackground','background')" class="ChooseImage">选择</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="upyunPicUpload('endbackground',1500,1000,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="viewImg('endbackground')" class="ChooseImage">预览</a> 
</TD>
</TR>
<TR>
  <TH valign="top"><label for="text">二维码：</label></TH>
  <TD><input type="input" class="px" id="qrcode" value="<?php echo ($info["qrcode"]); ?>" name="qrcode" style="width:250px" value="" >  <a href="###" onclick="upyunPicUpload('qrcode',800,800,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="viewImg('qrcode')" class="ChooseImage">预览</a>
</TD>
</TR>
<TR>
  <TH valign="top">状态：</TH>
...
<TR>
  ...
  <TD><input type="input" class="px" value="<?php echo ($info["firstprizepic"]); ?>" id="firstprizepic" name="firstprizepic" style="width:250px" value="" >  <a href="###" onclick="upyunPicUpload('firstprizepic',600,600,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="viewImg('firstprizepic')" class="ChooseImage">预览</a></td>
</TR>
...
<TR>
  ...
  <TD><input type="input" class="px" value="<?php echo ($info["secondprizepic"]); ?>" id="secondprizepic" name="secondprizepic" style="width:250px" value="" >  <a href="###" onclick="upyunPicUpload('secondprizepic',600,600,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="viewImg('secondprizepic')" class="ChooseImage">预览</a></td>
</TR>
...
<TR>
  ...
  <TD><input type="input" class="px" value="<?php echo ($info["thirdprizepic"]); ?>" id="thirdprizepic" name="thirdprizepic" style="width:250px" value="" >  <a href="###" onclick="upyunPicUpload('thirdprizepic',600,600,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="viewImg('thirdprizepic')" class="ChooseImage">预览</a></td>
</TR>
...
<TR style="display:none">
  ...
  <TD><input type="input" class="px" value="<?php echo ($info["fourthprizepic"]); ?>" id="fourthprizepic" name="fourthprizepic" style="width:250px" value="" >  <a href="###" onclick="upyunPicUpload('fourthprizepic',600,600,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="viewImg('fourthprizepic')" class="ChooseImage">预览</a></td>
</TR>
...
<TR style="display:none">
  ...
  <TD><input type="input" class="px" value="<?php echo ($info["fifthprizepic"]); ?>" id="fifthprizepic" name="fifthprizepic" style="width:250px" value="" >  <a href="###" onclick="upyunPicUpload('fifthprizepic',0,0,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="viewImg('fifthprizepic')" class="ChooseImage">预览</a></td>
</TR>
...
<TR style="display:none">
  ...
  <TD><input type="input" class="px" value="<?php echo ($info["sixthprizepic"]); ?>" id="sixthprizepic" name="sixthprizepic" style="width:250px" value="" >  <a href="###" onclick="upyunPicUpload('sixthprizepic',600,600,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>&nbsp;&nbsp;&nbsp;<a href="###" onclick="viewImg('sixthprizepic')" class="ChooseImage">预览</a></td>
</TR>

<TR>
  <TH></TH>
  <TD><input type="hidden" value="<?php echo ($info["id"]); ?>" name="id" /><button type="submit"  name="button"  class="btn btn-success left" >保存</button>　
  	</TD>
  </TR>
  </TBODY>
</TABLE>
