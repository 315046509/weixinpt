  ...
  <div  class="quick-actions_homepage">
    ...
    <ul class="quick-actions">
      ...
      <li class="bg_lh"> <a href="/index.php?g=User&m=Member_card&a=staff&token=<?php echo ($token); ?>&id=<?php echo ($thisCard["id"]); ?>"> <i class="icon-globe"></i> 管理员设置</a> </li>
          ...
          <h4><?php echo ($thisCard["cardname"]); ?>：设置会员卡通知</h4><a href="javascript:history.go(-1);" class="right btnGrayS vm" style="margin-top:-27px">返回</a></div>
		...
		<td>
			...
			<input type="input" class="px" id="enddate" name="enddate" value="<?php echo (date("Y-m-d",$thisNotice["endtime"])); ?>" onClick="WdatePicker()">
              	...
              	<tr>
              		...
              		<td><textarea name="content1" id="content1" rows="5" style="width: 410px; height: 250px; border:1px solid #ccc ;"><?php echo ($thisNotice["title"]); ?></textarea></td>
