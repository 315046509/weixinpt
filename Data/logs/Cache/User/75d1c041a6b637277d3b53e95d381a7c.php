...
<div class="tab">
<ul>
<li class="<?php if(ACTION_NAME == 'index'): ?>current<?php endif; ?> tabli" id="tab0"><a href="<?php echo U('Ktv/index',array('token'=>$token));?>">经营主体介绍</a></li>
<li class="<?php if(ACTION_NAME == 'son' ): ?>current<?php endif; ?> tabli" id="tab2"><a href="<?php echo U('Ktv/son',array('token'=>$token));?>">KTV分店</a></li>
<li class="<?php if(ACTION_NAME == 'housetype' ): ?>current<?php endif; ?> tabli" id="tab2"><a href="<?php echo U('Ktv/housetype',array('token'=>$token));?>">KTV包厢</a></li>
<li class="<?php if(ACTION_NAME == 'album' or ACTION_NAME == 'album_add'): ?>current<?php endif; ?> tabli" id="tab5"><a href="<?php echo U('Ktv/album',array('token'=>$token));?>">宣传相册</a></li>
<li class="<?php if(ACTION_NAME == 'expert'): ?>current<?php endif; ?> tabli" id="tab5"><a href="<?php echo U('Ktv/expert',array('token'=>$token));?>">客人印象</a></li>
<li class="<?php if(ACTION_NAME == 'ktvindex'): ?>current<?php endif; ?> tabli" id="tab6"><a href="<?php echo U('Reservation/ktvindex',array('token'=>$token));?>">预约管理</a></li>
          ...
          <div class="cLine">
            <div class="pageNavigator left">
                <a href="<?php echo U('Reservation/add',array('token'=>$token,'thetype'=>'ktv'));?>" class="btnGrayS vm bigbtn">
              ...
              <thead>
				  ...
				  <tbody>
					<?php if(is_array($reslist)): $i = 0; $__LIST__ = $reslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr> 
						   ...
						   <td > 
								<a href="<?php echo U('Reservation/manage',array('token'=>$vo['token'],'thetype'=>'ktv','id'=>$vo['id']));?>" class="btn" title="订单管理">订单管理</a>
								<a class="btn" href="<?php echo U('Reservation/edit',array('token'=>$vo['token'],'thetype'=>'ktv','id'=>$vo['id']));?>" title="编辑">编辑</a> 
								<a class="btn" href="<?php echo U('Reservation/del',array('token'=>$vo['token'],'thetype'=>'ktv','id'=>$vo['id']));?>" onclick="return(confirm('确定要删除吗？'))"  title="删除">删除</a></td>
