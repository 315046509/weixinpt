...
<div class="tab">
<ul>
<li class="<?php if(ACTION_NAME == 'index'): ?>current<?php endif; ?> tabli" id="tab0"><a href="<?php echo U('Shipin/index',array('token'=>$token));?>">公司介绍</a></li>
<li class="<?php if(ACTION_NAME == 'son' ): ?>current<?php endif; ?> tabli" id="tab2"><a href="<?php echo U('Shipin/son',array('token'=>$token));?>">销售分店</a></li>
<li class="<?php if(ACTION_NAME == 'housetype' ): ?>current<?php endif; ?> tabli" id="tab2"><a href="<?php echo U('Shipin/housetype',array('token'=>$token));?>">食品分类</a></li>
<li class="<?php if(ACTION_NAME == 'album' or ACTION_NAME == 'album_add'): ?>current<?php endif; ?> tabli" id="tab5"><a href="<?php echo U('Shipin/album',array('token'=>$token));?>">宣传相册</a></li>
<li class="<?php if(ACTION_NAME == 'expert'): ?>current<?php endif; ?> tabli" id="tab5"><a href="<?php echo U('Shipin/expert',array('token'=>$token));?>">用户点评</a></li>
<li class="<?php if(ACTION_NAME == 'ktvindex'): ?>current<?php endif; ?> tabli" id="tab6"><a href="<?php echo U('Reservation/ktvindex',array('token'=>$token));?>">预约管理</a></li>
  ...
  <input type="hidden" name="thetype" value="食品公司">
<?php if($es_data['id'] != ''): ?><input type="hidden" name="id" value="<?php echo ($es_data['id']); ?>" /><?php endif; ?>
	...
	<div class="control-group">
		...
		<div class="controls">
      <img class="thumb_img" id="cover_src" src="<?php echo (($es_data['cover'])?($es_data['cover']):'./tpl/static/sucai/shipin/1.jpg'); ?>" style="max-height:100px;">
     <input type="text" name="cover" value="<?php echo (($es_data['cover'])?($es_data['cover']):'./tpl/static/sucai/shipin/1.jpg'); ?>" id="cover" class="px" style="width:150px;" /><script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('cover',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a> 
	...
	<div class="control-group">
         <label class="control-label">经营主体头部图片：</label>
                                    <div class="controls">
                                        <img class="thumb_img" id="banner_src" src="<?php echo (($es_data['banner'])?($es_data['banner']):'./tpl/static/sucai/shipin/2.jpg'); ?>" style="max-height:100px;"> 
                                        
                                            <input type="text" id="banner" name="banner" class="px" value="<?php echo (($es_data['banner'])?($es_data['banner']):'./tpl/static/sucai/shipin/2.jpg'); ?>"><script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('banner',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
	...
	<div class="control-group">
		<div class="control-group">
                                    <label class="control-label">公司分店头部图片：</label>
                                    <div class="controls">
                                        <img class="thumb_img" id="house_banner_src" src="<?php echo (($es_data['house_banner'])?($es_data['house_banner']):'./tpl/static/sucai/shipin/3.jpg'); ?>" style="max-height:100px;">
                                        <input type="text" name="house_banner" id="house_banner" class="px" value="<?php echo (($es_data['house_banner'])?($es_data['house_banner']):'./tpl/static/sucai/shipin/3.jpg'); ?>"><script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('house_banner',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
	...
	<div class="control-group">
                                    <label for="album_title" class="control-label">食品公司全景：</label>
                                    <div class="controls">
                                    <select id="panorama_id" name="panorama_id" class="input-medium" data-rule-required="true"> 
                                          <option value="0">请选择公司全景相册</option> 
