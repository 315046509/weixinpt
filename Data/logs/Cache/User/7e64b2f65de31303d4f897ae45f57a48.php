...
<div class="content" style="width:98%; background:none; margin-left:15px; border:none; padding-top:30px;" >
   ...
   <div class="cLineE"> 
    <h4>题目设置</h4> 
    <a href="<?php echo U('Diaoyan/timu',array('token'=>$token));?>" class="right  btn btn-success" style="margin-top:-27px">返回</a> 
   </div> 

   <form class="form" method="post" id="form" action="" enctype="multipart/form-data"> 
<!-- <?php if($isUpdate == 1): ?><input type="hidden" name="tid" value="<?php echo ($set["id"]); ?>" /><?php endif; ?> -->
    <div class="msgWrap bgfc"> 
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody> 
       <input type="hidden" name="pid" value="<?php echo ($pid); ?>" />
	   <tr> 
        <th><span class="red"></span>题目名称：</th>
        <td><input type="text" name="title" id="keyword" value="<?php echo ($set["title"]); ?>" class="px" style="width:400px;" /></td> 
       </tr>
	   
	   <tr> 
        <th ><span class="red"></span>选项A：</th> 
        <td><input  type="text"  name="optia" value="<?php echo ($set["optia"]); ?>" class="px require" style="width:400px;" /></td> 
       </tr> 
	   
	   <tr> 
        <th ><span class="red"></span>选项B：</th> 
        <td><input  type="text" name="optib" value="<?php echo ($set["optib"]); ?>" class="px require" style="width:400px;" /></td> 
       </tr> 
	   
	   <tr> 
        <th ><span class="red"></span>选项C：</th> 
        <td><input  type="text" name="optic" value="<?php echo ($set["optic"]); ?>" class="px require" style="width:400px;" /></td> 
       </tr> 
	   
	   <tr> 
        <th ><span class="red"></span>选项D：</th> 
        <td><input  type="text"name="optid" value="<?php echo ($set["optid"]); ?>" class="px require" style="width:400px;" /></td> 
       </tr> 
  
	   <tr> 
        <th ><span class="red"></span>选项E：</th> 
        <td><input  type="text" name="optie" value="<?php echo ($set["optie"]); ?>" class="px require" style="width:400px;" /></td> 
       </tr> 
		
	   <tr> 
        <th ><span class="red"></span>题目答案最多数目：</th> 
        <td>
			<select name="max" style="width:80px;" >
       ...
       <button type="submit" class="btn btn-success">保存</button> &nbsp; <a href="<?php echo U('Diaoyan/addTimu',array('token'=>$token));?>" class="btn btn-info">取消</a></td> 
       </tr> 
