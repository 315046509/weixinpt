...
<h4>添加文章分类</h4><a href="javascript:history.go(-1);"  class="right btn btn-info" style="margin-top:-27px" >返回</a></div> 
<div class="msgWrap">
...
<TH valign="top"><label for="keyword">网站图标选择 ：</label></TH>
                                     <TD>   <div class="i-cont tile-themed btn btn-success">
...
<TR>
  ...
  <TD><input type="input" class="px" id="img" value="" name="img" id="img" style="width:500px" >  <script src="/tpl/static/upyun.js?2013"></script><a href="###" onclick="chooseFile('img','icon')" class="ChooseImage">选择</a> <a href="###" onclick="upyunPicUpload('img',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a> <a href="###" onclick="viewImg('img')" class="ChooseImage">预览</a></TD>
  <TD>&nbsp;</TD>
</TR>

<tr>
<TH valign="top"><label for="keyword">按钮背景颜色选择：</label></TH>
<td><input type="text" name="yanse" id="themeStyle" value="<?php echo ($info["yanse"]); ?>" class="px color" style="width: 55px; background-image: none; background-color:<?php echo ($info["yanse"]); ?>; color: rgb(255, 255, 255);" onblur="document.getElementById('yanse').style.backgroundColor=document.getElementById('themeStyle').value;">部分模板需要改变按钮背景的颜色，请根据模板需要进行填写！</td>
</tr>

<TR>
  <TH valign="top"><label for="keyword">外链网站或活动 ：</label></TH>
  <TD><input type="input" class="px" id="url" value="" name="url" style="width:300px" > <a href="###" onclick="addLink('url',0)" class="ChooseImage">从功能库添加</a><a href="<?php echo U('Wo138/index',array('token'=>$token));?>" target="_blank"  class="ChooseImage" >添加实用外链</a><a href="<?php echo U('Daohang/index',array('token'=>$token));?>" target="_blank"  class="ChooseImage" >添加一键导航</a><br />
  </TD>
  <TD>&nbsp;</TD>
</TR>
<TR>
...
<TR>
  ...
  <TD>
	...
	<a class="ChooseImage" onclick="chooseTpl('tpid','selecttpl',1)">选择模板</a>
	<a class="ChooseImage" onclick="viewTpl()">预览</a>
	<script>
		function viewTpl(){
			var tid = $('#tpid').val();
			chooseTpl(tid,'',2);
...
<tr>
  ...
  <TD>
	...
	<a class="ChooseImage" onclick="chooseTpl('conttpid','selectconttpl',3)">选择模板</a>
	<a class="ChooseImage" onclick="viewTpl2()">预览</a>
...
<div class="row-fluid">
  <div id="footer" class="span12"> 2014 &copy; www.138wo Admin </div>
</div>

<!--end-Footer-part-->

<script src="<?php echo RES;?>/138/js/excanvas.min.js"></script> 
<script src="<?php echo RES;?>/138/js/jquery.ui.custom.js"></script> 
