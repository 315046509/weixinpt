    ...
    <p><span class="bold">使用方法：</span>请添加点评</p>
          ...
          <div class="cLine">
            <div class="pageNavigator left">
                <a href="<?php echo U('Lvyou/expert_add',array('token'=>$token));?>" class="btnGrayS vm bigbtn">
            ...
            <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
              <thead>
                                    ...
                                    <?php if(is_array($expert)): $i = 0; $__LIST__ = $expert;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td>
                                        <a href="<?php echo U('Lvyou/expert_add',array('id'=>$list['id'],'token'=>$list['token']));?>" class="btn">编辑</a>
                                        <a href="<?php echo U('Lvyou/expert_del',array('id'=>$list['id'],'token'=>$list['token']));?>" onclick="return(confirm('确定要删除吗？'))"  class="btn">删除</a></a>
</td>
