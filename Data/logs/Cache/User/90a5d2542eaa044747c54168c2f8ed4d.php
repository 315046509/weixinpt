...
﻿<div  class="quick-actions_homepage">
    <ul class="quick-actions">
      ...
      <li class="bg_lh"> <a href="<?php echo U('Yulan/index',array('token'=>$token));?>" target="_blank"> <i class="icon-globe"></i> 在线预览</a> </li>
          ...
          <h4>编辑文本自定义内容</h4><a href="javascript:history.go(-1);"  class="right btn btn-info" style="margin-top:-27px" >返回</a></div> 
<div class="msgWrap">
...
<TR>
  <TH></TH>
  <TD><button type="submit"  name="button"  class="btn btn-success left" >保存</button>　<a href="<?php echo U('Img/add');?>"  class="btn btn-info"  >切换到图文模式</a>　<a href="javascript:history.go(-1);"  class="btn btn-info">取消</a>
