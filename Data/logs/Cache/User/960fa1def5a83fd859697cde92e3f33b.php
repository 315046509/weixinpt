  ...
  <div  class="quick-actions_homepage">
    <ul class="quick-actions">
      ...
      <li class="bg_lh"> <a href="<?php echo U('Other/index',array('token'=>$token));?>" target="_blank"> <i class="icon-book"></i> 回答不上</a> </li>
            ...
            选择年份<select class="setting-period" name="year" id="year" onchange="doit($('#period').val())"><?php echo ($yearOption); ?></select> 选择月份&nbsp;&nbsp;<select class="setting-period" name="period" id="period" onchange="doit(this.value)">
