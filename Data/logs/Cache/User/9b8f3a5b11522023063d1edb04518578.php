...
<li class="<?php if(ACTION_NAME == 'jianshenindex'): ?>current<?php endif; ?> tabli" id="tab6"><a href="<?php echo U('Reservation/jianshenindex',array('token'=>$token));?>">预约管理</a></li>
          ...
          <div class="cLine">
            <div class="pageNavigator left" >
                <a href="<?php echo U('Jianshen/housetype_add',array('token'=>$token));?>" class="btnGrayS vm bigbtn">
                    <img src="tpl/User/default/common/images/pic.png" class="vm">添加健身室
                </a>
            </div>
            <div class="clr"></div>
          </div>
            ...
            <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
             ...
             <tr>
                                            ...
                                            <th class="span3">操作</th>
                                                  ...
                                                  <tbody>
                                        <?php if($housetype == ''): ?><tr>
                                        <td colspan="6" style="text-align:center; height:30px;"><strong>没有健身室信息.</strong></td>
                                        </tr>
                                    <?php else: ?>
                                    <?php if(is_array($housetype)): $i = 0; $__LIST__ = $housetype;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td style="">
                                        <a href="<?php echo U('Jianshen/housetype_add',array('id'=>$list['id'],'token'=>$list['token']));?>" class="btn">编辑</a>
                                        <a href="<?php echo U('Jianshen/housetype_del',array('id'=>$list['id'],'token'=>$list['token']));?>" onclick="return(confirm('确定要删除吗？'))" class="btn">删除</a></a>
                                        </td>
