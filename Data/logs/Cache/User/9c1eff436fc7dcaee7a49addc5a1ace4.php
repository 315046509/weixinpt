...
<div class="pageNavigator"> <a href="<?php echo U('Dining/ComIndex',array('token'=>$token,'isBranch'=>1));?>" title="" class="btn btn-primary"><img src="<?php echo RES;?>/images/icons/add.png" class="vm">添加</a></div>
<div class="clr"></div>
