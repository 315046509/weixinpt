  ...
  <div class="cLineB">
    ...
    <ul class="quick-actions">
      ...
      <li class="bg_db"> <a href="javascript:history.go(-1);"> <i class="icon-share-alt"></i> 返回</a> </li>
          ...
          <h4>关键词触发第三方接口</h4>
			<a href="<?php echo U('Api/index',array('token'=>$token));?>" class="right btn btn-info" style="margin-top:-27px">返回</a>
		  </div> 
<div class="msgWrap">
...
<tr>
  ...
  <th></th>
  <td><button type="submit" name="button" class="btn btn-success left">保存</button>　　<a href="<?php echo U('Api/index',array('token'=>$token));?>" class="btn btn-info">取消</a>
  <div class="clr"></div>
</td>
</tr>
  </tbody>
