...
<li class="<?php if(ACTION_NAME == 'ktvindex'): ?>current<?php endif; ?> tabli" id="tab6"><a href="<?php echo U('Reservation/ktvindex',array('token'=>$token));?>">预约管理</a></li>
          ...
          <div class="cLine">
    <div class="alert">
    <p><span class="bold">使用方法：</span> 如果您的整体经营主体由多个影厅项目组成，请在此添加，如果没有可以不添加。</p>
    </div>
</div>
          
          <div class="cLine">
            <div class="pageNavigator left">
                <a href="<?php echo U('Dianying/son_add',array('token'=>$token,'pid'=>$pid));?>" class="btnGrayS vm bigbtn">
                    <img src="tpl/User/default/common/images/pic.png" class="vm">添加影厅
                </a>
            </div>
            <div class="clr"></div>
          </div>
           ...
           <input name="wxid" type="hidden" value="gh_423dwjkewad">
            <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
              <thead>
               ...
               <tbody>
                                    <?php if($son_data == ''): ?><tr>
                                        <td colspan="4" style="text-align:center; height:30px;"><strong>没有任何影厅信息.</strong> 如果您的整体经营主体由多个影厅项目组成，请在此添加，如果没有可以不添加。</td>
                                        </tr>
                                    <?php else: ?>
                                    <?php if(is_array($son_data)): $i = 0; $__LIST__ = $son_data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td style="">
                                        <a href="<?php echo U('Dianying/son_add',array('id'=>$list['id'],'token'=>$list['token'],'pid'=>$pid));?>" class="btn">编辑</a>
                                        <a href="<?php echo U('Dianying/son_del',array('id'=>$list['id'],'token'=>$list['token']));?>" onclick="return(confirm('确定要删除吗？'))" class="btn">删除</a></a>
</td>
