...
<li class="<?php if(ACTION_NAME == 'aboutus'): ?>current<?php endif; ?> tabli" id="tab7"><a href="<?php echo U('Estate/aboutus',array('token'=>$token));?>">关于我们</a></li>
    ...
    <p><span class="bold">使用方法：</span>请添加专家点评，如果没有可以不添加。</p>
          ...
          <div class="cLine">
            <div class="pageNavigator left">
                <a href="<?php echo U('Estate/expert_add',array('token'=>$token));?>" class="btn btn-primary">
  ...
  <div class="msgWrap">
    <form method="post" action="" id="info">
      ...
      <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
        ...
        <tbody>
          <?php if($expert == ''): ?><tr>
              <td colspan="5" style="text-align:center; height:30px;"><strong>请加添加专家点评信息.</strong></td>
            </tr>
            <?php else: ?>
            <?php if(is_array($expert)): $i = 0; $__LIST__ = $expert;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                ...
                <td><a href="<?php echo U('Estate/expert_add',array('id'=>$list['id'],'token'=>$list['token']));?>" class="btn">编辑</a> <a href="<?php echo U('Estate/expert_del',array('id'=>$list['id'],'token'=>$list['token']));?>" onclick="return(confirm('确定要删除吗？'))"  class="btn">删除</a></a></td>
