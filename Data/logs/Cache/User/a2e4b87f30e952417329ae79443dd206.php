              ...
              <tbody>
                <tr>
                 ...
                 <tr>
                  ...
                  <td><input type="text" required="" name="yxid" value="<?php echo ($info["yxid"]); ?>" onmouseup="this.value=this.value.replace('_430','')" class="px" tabindex="1" size="25">　<span class="red">非必填项！没有易信号可随便输入</span></td>
                </tr>
                <tr>
                  <th><span class="red">*</span>微信号：</th>
                  <td><input type="text" required="" name="weixin" value="<?php echo ($info["weixin"]); ?>" class="px" tabindex="1" size="25">　比如：weixin </td>
                </tr>
                  <tr>
                  <th>头像地址（url）:</th>
                ...
                <tr>
                  ...
                  <td><input type="text" name="appid" value="<?php echo ($info["appid"]); ?>" class="px" tabindex="1" size="25">　高级认证服务号特权功能，微客服、粉丝管理等系统，可以不填 </td>
                </tr>
                <tr>
                  <th><span class="red"></span>AppSecret：</th>
                  <td><input type="text" name="appsecret" value="<?php echo ($info["appsecret"]); ?>" class="px" tabindex="1" size="25">　高级认证服务号特权功能，微客服、粉丝管理等系统，可以不填 </td>
                </tr>
