...
<!--tab end-->
<div class="pageNavigator"> <a href="<?php echo U('Groupon/add',array('token'=>$token));?>" title="添加" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加团购</a></div>
<div class="clr"></div>
<div class="msgWrap">
