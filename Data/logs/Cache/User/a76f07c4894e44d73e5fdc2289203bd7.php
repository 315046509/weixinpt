  ...
  <div class="cLineB">
    ...
    <ul class="quick-actions">
      ...
      <li class="bg_db"> <a href="javascript:history.go(-1);"> <i class="icon-share-alt"></i> 返回</a> </li>
          ...
          <h4>编辑贺卡</h4><a href="<?php echo U('User/Greeting_card/index');?>" class="right btn btn-info" style="margin-top:-27px">返回</a></div>
               ...
               <tr style="display:">
                ...
                <tr style="display:">
					  ...
					  <span class="help-inline">
						<a href="javascript:void(0)" onclick="upyunPicUpload('suicai1',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
						<a href="###" onclick="viewImg('suicai1')" class="ChooseImage">预览</a>
					  </span>
					  </td>
                </tr>
                <tr>
                  ...
                  <input class="px" name="bakcground_url" value="" id="suicai2" style="width:280px;">  
				  <span class="help-inline">
					<a href="javascript:void(0)" onclick="upyunPicUpload('suicai2',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
					<a href="###" onclick="viewImg('suicai2')" class="ChooseImage">预览</a>
				 </span> 只改变选中模版的背景图!
</td>
                </tr>
                <tr>
    <th><label for="title">背景音乐：</label></th>
     <td>
	 ...
	 <a href="###" onclick="chooseFile('suicai3','music')" class="ChooseImage">选择</a><br />
	 
	 <audio id="plmp3" src="" preload="none"></audio><font color="#FF0000"></font></td>
    </tr>
    <tr>
	 <th><label for="title">选择背景动画：</label></th>
	  <td>
		<select name="type"> 
			<option value=""   <?php if($greeting_card['type'] == ''): ?>selected<?php endif; ?>>请选择</option>
			 ...
			 <option value="3" <?php if($greeting_card['type'] == 3): ?>selected<?php endif; ?>>驱驴</option
