...
<!--tab end-->
<div class="pageNavigator"> <a href="<?php echo U('Product/catAdd',array('token'=>$token,'parentid'=>$parentid,'dining'=>$isDining));?>" title="新增分类" class="btn btn-primary"><img src="<?php echo RES;?>/images/product/add.png" class="vm">新增分类</a></div>
<div class="clr"></div>
<div class="msgWrap">
