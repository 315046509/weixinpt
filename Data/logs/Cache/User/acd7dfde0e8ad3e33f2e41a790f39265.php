...
<td><?php if($o["paid"] == 1): ?><span style="color:green">已付款</span><?php else: ?><span style="color:red">未付款</span><?php endif; ?> / <?php if($o["status"] == 1): ?><span style="color:green">已入住</span><?php else: ?><span style="color:red">未入住</span><?php endif; ?></td>
