...
<a href="http://demowx.duapp.com/tutorial/page1.html" target="_blank">点击查看如何制作一个360全景照片？</a>
...
<div class="pageNavigator"> <a href="<?php echo U('Panorama/add',array('token'=>$token));?>" title="" class="btn btn-primary"><img src="<?php echo RES;?>/images/product/add.png" class="vm">添加360°全景</a></div>
<div class="clr"></div>
