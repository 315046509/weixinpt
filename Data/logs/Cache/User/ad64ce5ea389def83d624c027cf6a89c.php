  ...
  <div class="cLineB">
    ...
    <ul class="quick-actions">
      ...
      <li class="bg_db"> <a href="javascript:history.go(-1);"> <i class="icon-share-alt"></i> 返回</a> </li>
          ...
          <h4>设置粉丝分组</h4><a href="javascript:history.go(-1);"  class="right btnGrayS vm" style="margin-top:-27px" >返回</a></div>
          ...
          <div class="msgWrap form">
            <TABLE class="userinfoArea" border="0" cellSpacing="0" cellPadding="0" width="100%">
                ...
                <TR>
                  <TH></TH>
                  <TD><?php if($thisGroup): ?><input type="hidden" name="id" value="<?php echo ($thisGroup['id']); ?>" /><?php endif; ?><input type="submit" value="保存" name="sbmt" class="btn btn-success left"></TD>
                </TR>
              </TBODY>
            </TABLE>
