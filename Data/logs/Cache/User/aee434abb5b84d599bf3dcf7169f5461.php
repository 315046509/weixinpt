...
<div class="content" style="width:98%; background:none; margin-left:15px; border:none; margin-bottom:30px;" >
          ...
          <div class="cLineB"><h4><?php echo ($thisCard["cardname"]); ?>：发布优惠券 <span class="FAQ">发布现金抵用券和打折优惠券信息</span></h4><a href="javascript:history.go(-1);" class="right btn btn-info" style="margin-top:-27px">返回</a></div>
...
<tr>
	...
	<td><button type="submit" name="button" class="btn btn-success">保存</button>　<a href="javascript:history.go(-1);" class="btn btn-info">取消</a></td>
