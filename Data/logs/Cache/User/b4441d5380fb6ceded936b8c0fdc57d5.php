  ...
  <div  class="quick-actions_homepage">
    <ul class="quick-actions">
      ...
      <li class="bg_lh"> <a href="<?php echo U('Other/index',array('token'=>$token));?>" target="_blank"> <i class="icon-book"></i> 回答不上</a> </li>
			...
			<h4>设置管理和消费验证密码</h4>
			<a href="javascript:history.go(-1);" class="right btn btn-info" style="margin-top:-27px">返回</a>
		</div>
<div class="tab">
...
<li class="tabli" id="tab0"><a href="<?php echo U('Company/branches',array('token'=>$token,'isBranch'=>1));?>">分支机构</a></li>

<li class="<?php if($isBranch == 1): ?>current<?php endif; ?> tabli" id="tab2"><a href="<?php echo U('Company/staff',array('token'=>$token,'isBranch'=>1));?>">商家密码设置</a></li>
...
<TABLE class="userinfoArea" style=" margin:20px 0 0 0;" border="0" cellSpacing="0" cellPadding="0" width="40%">
  <THEAD>
<TR>
  ...
  <th>所属店铺：</th>
  	...
  	</select> <a href="/index.php?g=User&m=Company&a=index&token=<?php echo ($token); ?>">添加店铺</a>
  	</td>
  	<th>  </th>
  	<td> </td>
  	</TR>
   <tr>
  	<th></th>
  	<td><button type="submit"  name="button"  class="btn btn-success left" >保存</button></td>
  	<td>&nbsp;</td>
  	<td>&nbsp;</td>
  	</tr>
  </TBODY>
