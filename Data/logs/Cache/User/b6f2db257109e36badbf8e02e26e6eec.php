...
﻿<div  class="quick-actions_homepage">
    <ul class="quick-actions">
      ...
      <li class="bg_lh"> <a href="<?php echo U('Yulan/index',array('token'=>$token));?>" target="_blank"> <i class="icon-globe"></i> 在线预览</a> </li>
          	...
          	<h4>创建相册</h4><a href="javascript:history.go(-1);" class="right btn btn-info" style="margin-top:-27px">返回</a></div>
...
<tr>
	...
	<td>
		...
		<a href="index.php?ac=photo-list&amp;id=9878" class="btn btn-danger">取消</a></td>
		<td>&nbsp;
	</td>
</tr>
</tbody>
