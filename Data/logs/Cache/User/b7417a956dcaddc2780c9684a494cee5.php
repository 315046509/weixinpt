...
<div class="pageNavigator"> <a href="<?php echo U('Product/add',array('token'=>$token,'dining'=>$isDining));?>" title="添加" class="btn btn-primary"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加<?php if($isDining != 1): ?>商品<?php else: ?>菜品<?php endif; ?></a></div>
