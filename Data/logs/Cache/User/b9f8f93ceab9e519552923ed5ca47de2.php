...
<div class="tab">
<ul>
<li class="<?php if(ACTION_NAME == 'index'): ?>current<?php endif; ?> tabli" id="tab0"><a href="<?php echo U('Jianshen/index',array('token'=>$token));?>">俱乐部介绍</a></li>
<li class="<?php if(ACTION_NAME == 'son' ): ?>current<?php endif; ?> tabli" id="tab2"><a href="<?php echo U('Jianshen/son',array('token'=>$token));?>">健身房</a></li>
<li class="<?php if(ACTION_NAME == 'housetype' ): ?>current<?php endif; ?> tabli" id="tab2"><a href="<?php echo U('Jianshen/housetype',array('token'=>$token));?>">健身室</a></li>
<li class="<?php if(ACTION_NAME == 'album' or ACTION_NAME == 'album_add'): ?>current<?php endif; ?> tabli" id="tab5"><a href="<?php echo U('Jianshen/album',array('token'=>$token));?>">健身相册</a></li>
<li class="<?php if(ACTION_NAME == 'impress'): ?>current<?php endif; ?> tabli" id="tab5" style="display:none"><a href="<?php echo U('Jianshen/impress',array('token'=>$token));?>" style="display:none">会员印象</a></li>
<li class="<?php if(ACTION_NAME == 'expert'): ?>current<?php endif; ?> tabli" id="tab5"><a href="<?php echo U('Jianshen/expert',array('token'=>$token));?>">专家点评</a></li>
<li class="<?php if(ACTION_NAME == 'jianshenindex'): ?>current<?php endif; ?> tabli" id="tab6"><a href="<?php echo U('Reservation/jianshenindex',array('token'=>$token));?>">预约管理</a></li>
</ul>
</div>
  ...
  <input type="hidden" name="thetype" value="jianshen">
<?php if($es_data['id'] != ''): ?><input type="hidden" name="id" value="<?php echo ($es_data['id']); ?>" /><?php endif; ?>
	...
	<div class="control-group">
		...
		<div class="controls">
      <img class="thumb_img" id="cover_src" src="<?php echo (($es_data['cover'])?($es_data['cover']):'./tpl/static/sucai/jianshen/1.jpg'); ?>" style="max-height:100px;">
      <input type="text" name="cover" value="<?php echo (($es_data['cover'])?($es_data['cover']):'./tpl/static/sucai/jianshen/1.jpg'); ?>" id="cover" class="px" style="width:150px;" ><script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('cover',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a> 
	...
	<div class="control-group">
         <label class="control-label">俱乐部头部图片：</label>
                                    <div class="controls">
                                        <img class="thumb_img" id="banner_src" src="<?php echo (($es_data['banner'])?($es_data['banner']):'./tpl/static/sucai/jianshen/2.png'); ?>" style="max-height:100px;"> 
                                        
                                            <input type="text" id="banner" name="banner" class="px" value="<?php echo (($es_data['banner'])?($es_data['banner']):'./tpl/static/sucai/jianshen/2.png'); ?>"><script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('banner',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
	...
	<div class="control-group">
		<div class="control-group">
                                    ...
                                    <div class="controls">
                                        <img class="thumb_img" id="house_banner_src" src="<?php echo (($es_data['house_banner'])?($es_data['house_banner']):'./tpl/static/sucai/jianshen/4.png'); ?>" style="max-height:100px;">
                                        <input type="text" name="house_banner" id="house_banner" class="px" value="<?php echo (($es_data['house_banner'])?($es_data['house_banner']):'./tpl/static/sucai/jianshen/4.png'); ?>"><script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('house_banner',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a>
...
<div class="control-group">
		<label for="place" class="control-label">俱乐部地址：</label>
		<div class="controls"> 
...
<div class="control-group">
     ...
     <div class="control-group">
         <label for="project_brief" class="control-label">俱乐部简介：</label>
         <div class="controls">
     ...
     <div class="control-group">
        <label for="traffic_desc" class="control-label">服务内容：</label>
        <div class="controls">
