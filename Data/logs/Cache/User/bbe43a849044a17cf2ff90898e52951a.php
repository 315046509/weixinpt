...
<div class="content" style="width:95%; background:none; margin-left:25px; border:none; margin-bottom:30px; margin-top:10px;" >
  ...
  <a href='<?php echo U("Wxq/add");?>' title='添加微信墻' class='btnGrayS vm bigbtn'><img src="<?php echo RES;?>/images/text.png" class="vm" />新建微信墻</a>
            ...
            <TABLE class="ListProduct" border="0" cellSpacing="0" cellPadding="0" width="100%">
              ...
              <TBODY>
				...
				<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
                  ...
                  <td><div align="center"><?php echo ($vo["keyword"]); ?></div></td>
                  <td><div align="center"><?php echo ($vo["title"]); ?></div></td>
                  <td><div align="center"><?php echo ($vo["send_tips"]); ?></div></td>
                  <td><div align="center"><?php echo ($vo["timeout"]); ?></div></td>
                 <td><div align="center"><?php echo ($vo["showtime"]); ?></div></td>

                   <td><div align="center">
                       <a href="<?php echo U('Wxq/edit',array('id'=>$vo['id']));?>" title="编辑文本">编辑</a>
                       <a href="<?php echo U('Wxq/del',array('id'=>$vo['id']));?>">删除</a>
                       <?php if(($vo["isshow"]) == "1"): ?><a href="<?php echo U('Wxq/examineInfo',array('id'=>$vo['id'],'isshow'=>0));?>" target="_blank">审核显示内容</a>
                   <?php else: ?>未开启审核<?php endif; ?>
                   <a target="_blank" href="<?php echo U('Wxq/detail',array('id'=>$vo['id']));?>" >我的墻面</a>
                   <a href="<?php echo U('Wxq/awardList',array('id'=>$vo['id']));?>">中奖用户</a></div>
                   </td>
