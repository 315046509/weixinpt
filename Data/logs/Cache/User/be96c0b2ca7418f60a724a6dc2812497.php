...
<p><span>使用方法：</span><span style="color:red;">（注：系统默认为至少添加6项房友印象）</span></p>
            ...
            <table class="ListProduct" border="0" cellspacing="0" cellpadding="0" width="100%">
              <thead>
                                    ...
                                    <?php if(is_array($impress)): $i = 0; $__LIST__ = $impress;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
                                        ...
                                        <td style=""><span class="label"> <?php echo ($list['comment']); ?></span></td>
                                        <td style=""><span class="label"><?php if($list['is_show'] == 1): ?>显示<?php else: ?>不显示<?php endif; ?></span></td>
