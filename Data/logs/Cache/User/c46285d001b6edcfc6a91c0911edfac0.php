...
<h4 class="left">自定义表单,报名,留言,预约 (<?php echo ($page); ?>) </h4>
...
<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Selfform/add',array('token'=>$token));?>" title="添加" class="btn btn-primary"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加</a></div>
<div class="clr"></div>
</div>
<div class="msgWrap">
