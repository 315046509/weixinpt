               ...
               <tr>
                ...
                <tr>
                 ...
                 <tr>
                  ...
                  <td><input type="text"  name="picurl"  id="pic" value="<?php echo ($taobao["picurl"]); ?>"   class="px" tabindex="1" size="80" readonly="readonly"><script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('pic',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a> <a href="###" onclick="viewImg('pic')" class="ChooseImage">预览</a></td>
                </tr>
                <tr>
                ...
                <tr>
                  <th valign="top"></th>
                  <td>例如：天猫3G店铺地址通常为：<a href="http://beilimy.m.tmall.com/" target="_blank">http://weiwo.m.tmall.com/</a>　 淘宝的3G店铺地址为：<a href="http://shop104008058.m.taobao.com/" target="_blank">http://shop1003959.m.taobao.com/</a><br />    
                  	</td>
                </tr>
                <tr>
                  <th></th>
                  <td><button type="submit" name="appidsubmit" value="true" class="btn btn-success vm" ><strong>保存</strong></button></td>
                </tr>
              </tbody>
            </table>
</form>
