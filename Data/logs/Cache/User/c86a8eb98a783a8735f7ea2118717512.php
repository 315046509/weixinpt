...
<TR>
  ...
  <TD><input type="input" class="px" id="url" value="<?php echo ($info["url"]); ?>" name="url" style="width:300px" ><a href="###" onclick="addLink('url',0)" class="ChooseImage">从功能库添加</a><a href="<?php echo U('Wo138/index',array('token'=>$token));?>" target="_blank"  class="ChooseImage" >添加实用外链</a><a href="<?php echo U('Daohang/index',array('token'=>$token));?>" target="_blank"  class="ChooseImage" >添加一键导航</a><br />
                   </TD>
  <TD>&nbsp;</TD>
</TR>
<TR>
