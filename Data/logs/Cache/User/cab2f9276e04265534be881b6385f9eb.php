...
<div class="tab">
	<ul>
		...
		<li class="<?php if(ACTION_NAME == 'son'): ?>current<?php endif; ?> tabli" id="tab2"><a href="<?php echo U('ServiceUser/chat_log',array('token'=>$token));?>">聊天记录管理</a></li>
          ...
          <div class="cLine">
    <div class="alert">
    <p><span class="bold">工号管理：</span>添加工号后，在登陆的时候填写工号，密码，token即可。登录地址：<a href="/index.php?g=Chat&m=Login&a=index" target="_blank"><?php echo C('site_url');?>/index.php?g=Chat&m=Login&a=index</a></p>
    </div>
</div>
             ...
             <tr>                          
				...
				<tbody>
					...
					<?php if(is_array($list)): $i = 0; $__LIST__ = $list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$list): $mod = ($i % 2 );++$i;?><tr>
						<td><div align="center"><?php echo ($list['userName']); ?>@<?php echo ($token); ?></div></td>
						<td><div align="center"><span class="label"> <?php echo ($list['name']); ?></span></div></td>
						<td><?php if($list['online'] == 1): ?><div align="center"><span style="color:green">在线</span>
						  <?php else: ?>离线</div><?php endif; ?></td>
						<td>
