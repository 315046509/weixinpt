...
<li class="<?php if(ACTION_NAME == 'Reservation'): ?>current<?php endif; ?> tabli" id="tab6"><a href="<?php echo U('Reservation/lvyouindex',array('token'=>$token,'thetype'=>'estate'));?>">预定门票</a></li>
  ...
  <h4 style="padding-top:10px;">添加景区 </h4><a href="javascript:history.go(-1);return false;" class="right btnGrayS vm" style="margin-top:-27px">返回</a>
 </div>
    ...
    <div class="msgWrap bgfc">
	  <form class="form" method="post" action="" target="_top" >	 
		<table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%">
			<tbody>
				<tr>
				  <th valign="top"><span class="red">*</span>景区名称：</th>
				  <td>
				  	<input type="hidden" name="thetype" value="Lvyou">
					 <input type="text" id="title" name="title" value="<?php echo ($son['title']); ?>" class="input-large px" data-rule-required="true" data-rule-maxlength="20">
                                        <span class="maroon">*</span>
                                        <span class="help-inline">尽量简单，不要超过20字</span></td>
				</tr>
				<tr>
					<th width="120">显示顺序</th>
					<td> <input type="text" id="sort" name="sort" value="<?php echo (($son['sort'])?($son['sort']):1); ?>" class="input-mini px" data-rule-required="true" data-rule-number="true">
                                        <span class="maroon">*</span>
                                        <span class="help-inline">数值越大越靠前</span></td>
				</tr>
				<tr>
					<th>景区介绍：</th>
					<td><textarea id="description" name="description" style="width:560px;height:75px" data-rule-maxlength="150" placeholder="可不填"><?php echo ($son['description']); ?></textarea></td>
				</tr>
				<th>&nbsp;</th>
