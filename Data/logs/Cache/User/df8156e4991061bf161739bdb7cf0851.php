...
﻿  <div class="cLineB">
    ...
    <h4>酒吧管理 </h4>
		<ul>
		<a href="<?php echo U('Jiuba/index',array('token'=>$token));?>"><li class="current tabli" id="tab0">酒吧管理</li></a>
		<a href="<?php echo U('Jiuba/infos',array('token'=>$token,'pid'=>$set['id']));?>"><li class="tabli" id="tab2">订单管理</li></a>
		<a href="<?php echo U('Jiuba/setcin',array('token'=>$token,'pid'=>$set['id']));?>"><li class="tabli" id="tab2">套餐设置</li></a>
		<a href="<?php echo U('Jiuba/setinfo',array('token'=>$token,'pid'=>$set['id']));?>"><li class="tabli" id="tab2">表单设置</li></a>
		</ul>
	</div>
<div class="clr"></div>
</div>
