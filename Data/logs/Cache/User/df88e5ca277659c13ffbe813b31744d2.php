...
<a href="<?php echo U('Store/catAdd', array('token' => $token));?>" title="新增分类" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" class="vm">新增分类</a> <a href="<?php echo U('Store/setting', array('token' => $token));?>" title="商城设置" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" class="vm">商城设置</a>
</div>
<div class="msgWrap">
