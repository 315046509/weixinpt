...
<!--tab end-->
<div class="pageNavigator"> <a href="<?php echo U('Dining/add',array('token'=>$token,'dining'=>$isDining));?>" title="添加" class="btn btn-primary"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加<?php if($isDining != 1): ?>商品<?php else: ?>菜品<?php endif; ?></a></div>
<div class="clr"></div>
<div class="msgWrap">
...
<td><div class="cateimg"><?php if($hostlist['logourl']): ?><img src="<?php echo ($hostlist["logourl"]); ?>" width="48" style="vertical-align:middle;"/><?php endif; ?> <?php echo ($hostlist["name"]); ?></div></td>
