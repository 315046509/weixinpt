...
<div class="content" style="width:95%; background:none; margin-left:25px; border:none; margin-bottom:30px; margin-top:30px;" >
  ...
  <a href='<?php echo U('Guajiang/add',array('token'=>$token));?>' title='新增刮刮卡活动' class='btn btn-primary'><img src="<?php echo RES;?>/images/img/activity-scratch-card.png" class="vm" />新增刮刮卡活动</a>
              ...
              <TBODY>
                <TR></TR>
                  ...
                  <TD>刮刮卡 <?php echo ($list["id"]); ?></TD>
				   ...
				   <a href="index.php?g=User&m=Guajiang&a=sn&id=<?php echo ($list["id"]); ?>&type=2"><span class="btn btn-info btn-mini">SN码管理</span></a> 
				   <a href="index.php?g=User&m=Guajiang&a=edit&id=<?php echo ($list["id"]); ?>"><span class="btn btn-info btn-mini">编辑</span></a>  
				   ...
				   <a class="btn btn-danger btn-mini" href="index.php?g=User&m=Guajiang&a=del&id=<?php echo ($list["id"]); ?>">删除</a></TD>
