...
﻿  <div class="cLineB">
    ...
    <a href="<?php echo U('Selfform/index',array('token'=>$token));?>" class="right  btn btn-success" style="margin-top:-27px">返回</a> 
    ...
    <div class="msgWrap bgfc"> 
     ...
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      ...
      <input type="hidden" name="groupon" value="1" />
       ...
       <button type="submit" name="button" class="btn btn-success">保存</button> &nbsp; <a href="<?php echo U('Groupon/products',array('token'=>$token));?>" class="btn btn-info">取消</a></td> 
