...
<div class="cLineE">
<h4 class="left">题目列表 (<?php echo ($page); ?>) </h4>
...
<div class="cLine">
<div class="pageNavigator left"> <a href="<?php echo U('Diaoyan/addTimu',array('token'=>$token,'id'=> $id));?>" title="添加" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/add.png" width="16" class="vm">添加</a></div>
<div class="clr"></div>
</div>
...
<div class="msgWrap">
	...
	<tr>
	<th width="30">序号</th>
	<th width="200">调研题目</th>
	<th width="200">题目数量</th>
	...
	<?php if(is_array($data)): $i = 0; $__LIST__ = $data;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$item): $mod = ($i % 2 );++$i;?><tr>
		...
		<td class="norightborder">
			<a href="<?php echo U('Diaoyan/setTimu',array('id'=>$item['tid'],'token'=>$token, 'pid'=>$item['pid']));?>">修改</a>&nbsp;&nbsp;
			<a href="<?php echo U('Diaoyan/delTimu',array('id'=>$item['tid'],'token'=>$token, 'pid'=>$item['pid']));?>">删除</a>
		</td>
