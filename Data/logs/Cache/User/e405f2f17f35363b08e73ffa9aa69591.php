...
<a href="index.php?ac=erweima-edit&amp;id=9878" class="btn btn-info">取消</a>

<a href="<?php echo C('site_url');?>/index.php/show/<?php echo (session('token')); ?>" class="right btn btn-info" target="ddd" style=" margin-right:20px" target="_blank">查看推广页</a>
