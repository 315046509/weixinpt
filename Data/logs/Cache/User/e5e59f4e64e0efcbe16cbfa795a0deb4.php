...
<div class="pageNavigator"> <a href="###" onclick="$('#info').submit()" title="批量删除" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/product/arrow_switch.png" class="vm">批量删除</a></div>
<div class="clr"></div>
