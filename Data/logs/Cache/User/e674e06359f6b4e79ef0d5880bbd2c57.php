...
<li class="tabli" id="tab0"><a href="<?php echo U('Company/staff',array('token'=>$token,'isBranch'=>1));?>">商家密码设置</a></li>
</ul>
</div>
<!--tab end-->
<div class="msgWrap">
<form method="post" action="" id="info">
<div class="pageNavigator"> <a href="<?php echo U('Company/index',array('token'=>$token,'isBranch'=>1));?>" title="" class="btnGrayS vm bigbtn"><img src="<?php echo RES;?>/images/icons/add.png" class="vm">添加</a></div>
<div class="clr"></div>
