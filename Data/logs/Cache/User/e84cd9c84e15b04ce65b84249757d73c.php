            ...
            <table class="userinfoArea" border="0" cellspacing="0" cellpadding="0" width="100%">
              <thead>
				...
				<tr>
                  ...
                  <span class="red">商城、团购、订餐通知</span>
                  </td>
                </tr>
				<tr>
				...
				<tr>
                  <th><span class="red">*</span>通用订单：</th>
                  <td>
				  <input type="radio" value="1" <?php if($config["dingdan"] == 1): ?>checked="checked"<?php endif; ?> name="dingdan"/>开启
				  <input type="radio" value="0" name="dingdan" <?php if($config["dingdan"] == 0): ?>checked="checked"<?php endif; ?>/>关闭
                  <span class="red">通用订单通知</span>
                  </td>
                </tr>
				<tr>
                  <th><span class="red">*</span>万能表单：</th>
                  <td>
				  <input type="radio" value="1" <?php if($config["biaodan"] == 1): ?>checked="checked"<?php endif; ?> name="biaodan"/>开启
				  <input type="radio" value="0" name="biaodan" <?php if($config["biaodan"] == 0): ?>checked="checked"<?php endif; ?>/>关闭
                  <span class="red">万能表单通知</span>
                  </td>
                </tr>
				<tr>
                  <th><span class="red">*</span>投票调研：</th>
                  <td>
				  <input type="radio" value="1" <?php if($config["toupiao"] == 1): ?>checked="checked"<?php endif; ?> name="toupiao"/>开启
				  <input type="radio" value="0" name="toupiao" <?php if($config["toupiao"] == 0): ?>checked="checked"<?php endif; ?>/>关闭
                  <span class="red">投票调研通知</span>
                  </td>
                </tr>
				<div>
