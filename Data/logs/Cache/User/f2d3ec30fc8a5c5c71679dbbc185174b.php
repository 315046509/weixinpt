     ...
     <table class="userinfoArea" style=" margin:0;" border="0" cellspacing="0" cellpadding="0" width="100%"> 
      <tbody> 
       ...
       <tr> 
        ...
        <td><input type="password" id="password" name="password" value="<?php echo ($set["password"]); ?>" class="px require" style="width:200px;" />(修改时如果不想修改密码请留空)</td> 
       </tr> 
       <tr> 
       ...
       <tr> 
        ...
        <td><input type="text" id="logourl" name="logourl" value="<?php echo ($set["logourl"]); ?>" class="px require" style="width:400px;" /> <script src="/tpl/static/upyun.js"></script><a href="###" onclick="upyunPicUpload('logourl',700,420,'<?php echo ($token); ?>')" class="ChooseImage">上传</a> <a href="###" onclick="viewImg('logourl')" class="ChooseImage">预览</a></td> 
       </tr>
        <tr> 
