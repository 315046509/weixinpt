...
﻿  <div class="cLine">
  ...
  <h4>飞印无线打印平台设置</h4>
         ...
         <div class="zdhuifu">
                  <form method="post"  action="<?php echo U('Feiyin/insert');?>">
  
  <table cellspacing="0" cellpadding="0" border="0" width="100%">
  <tr><td height="5"></td><td></td></tr>
 <tr>
	<th style="text-align: left;width: 130px;font-size: 14px;font-weight: bold;line-height: 1.5;padding: 8px 0;"><span class="red"></span>商户编码：</th>
	<td>
		<input type="text" class="px require" style="width:420px;" value="<?php echo ($feiyin["member_code"]); ?>" name="member_code">
	</td>	
</tr>
 <tr>
	<th style="text-align: left;width: 130px;font-size: 14px;font-weight: bold;line-height: 1.5;padding: 8px 0;"><span class="red"></span>API密钥：</th>
	<td>
		<input type="text" class="px require" style="width:420px;" value="<?php echo ($feiyin["feyin_key"]); ?>" name="feyin_key">
	</td>	
</tr>
 <tr>
	<th style="text-align: left;width: 130px;font-size: 14px;font-weight: bold;line-height: 1.5;padding: 8px 0;"><span class="red"></span>设备编码：</th>
	<td>
		<input type="text" class="px require" style="width:420px;" value="<?php echo ($feiyin["device_no"]); ?>" name="device_no">
	</td>	
</tr>
<!--
<tr>
	<th style="text-align: left;width: 130px;font-size: 14px;font-weight: bold;line-height: 1.5;padding: 8px 0;"><span class="red"></span>打印状态：</th>
	<td>
		<label for="statu-1">
			开启
		</label>
		<input type="radio" name="emailstatus" <?php if(($info["emailstatus"] == 1) OR ($info['emailstatus'] == '')): ?>checked<?php endif; ?> id="statu-1" value="1">
		&nbsp;&nbsp;&nbsp;&nbsp;
		<label for="statu-0">
			关闭
		</label>
		<input type="radio" name="emailstatus" <?php if($info["emailstatus"] == 0): ?>checked<?php endif; ?> id="statu-0" value="0">
	</td>	
</tr>-->
<tr>
<td height="50">
