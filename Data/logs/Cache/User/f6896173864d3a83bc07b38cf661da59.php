...
<div class="tab">
  ...
  <a href="<?php echo U('ServiceUser/index');?>" class="right btnGrayS vm" style="margin-top:-27px">返回</a>
 </div> 
  ...
  <form action="" method="post" class="form-horizontal form-validate" novalidate="novalidate">
   ...
   <div class="form-actions">
			<button id="bsubmit" type="submit" data-loading-text="提交中..." class="btn btn-success">保存</button>　<a href="<?php echo U('ServiceUser/index');?>" class="btn btn-danger">取消</a>
		</div>
</form>
  </div> 
