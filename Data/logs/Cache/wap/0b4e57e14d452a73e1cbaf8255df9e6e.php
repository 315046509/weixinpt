...
<link href="<?php echo RES;?>/138wocss/allcss/cate<?php echo ($tpl["tpltypeid"]); ?>_<?php echo ($tpl["color_id"]); ?>.css" rel="stylesheet" type="text/css" />
    ...
    <!-- <link rel="stylesheet" type="text/css" href="<?php echo RES;?>/138wocss/116/common.css" media="all"> -->
    <link rel="stylesheet" type="text/css" href="<?php echo RES;?>/138wocss/116/reset.css" media="all">
    <link rel="stylesheet" type="text/css" href="<?php echo RES;?>/138wocss/116/font-awesome.css" media="all">
    <script type="text/javascript" src="<?php echo RES;?>/138wocss/116/jQuery.js"></script>
    <script type="text/javascript" src="<?php echo RES;?>/138wocss/116/swipe.js"></script>
    <script type="text/javascript" src="<?php echo RES;?>/138wocss/116/zepto.js"></script>
      
    </head>
    <body onselectstart="return true;" ondragstart="return false;">
    
    <!--背景音乐--><?php if($homeInfo['play_wifi'] == 'on'): ?><link rel="stylesheet" href="<?php echo RES;?>/css/auth/login.css" type="text/css">
<script>
...
<div class="body">
	...
	<section>
		<ul class="v12_ul">
                    <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li class="card_lol"  <?php if($i%2 == 1): ?>style="direction:rtl;"<?php endif; ?> >
                        <a href="<?php if($vo['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token'])); else: echo (htmlspecialchars_decode($vo["url"])); endif; ?>" class="tbox">
					<div style="vertical-align:middle;"><label><?php echo ($vo["name"]); ?></label><span></span></div>
					<div style="background-image: url(<?php echo ($vo["img"]); ?>)">
