...
<meta charset="utf-8">
<link href="<?php echo RES;?>/css/180/cate23_.css" rel="stylesheet" type="text/css" />
<link href="<?php echo RES;?>/css/180/iscroll.css" rel="stylesheet" type="text/css" />
...
<script src="<?php echo RES;?>/css/180/jquery.min.js" type="text/javascript"></script>
<script src="<?php echo RES;?>/css/180/idangerous.swiper.js" type="text/javascript"></script>
<script src="<?php echo RES;?>/css/180/iscroll.js" type="text/javascript"></script>
...
<ul>
<?php $ii=1; ?>
<?php if(is_array($vo['sub'])): $i = 0; $__LIST__ = $vo['sub'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$res): $mod = ($i % 2 );++$i; if($ii==1){echo '<li>';} ?>
<?php if($res['fid'] != 0 && $res['fid'] == $vo['id']): ?><a href="<?php if($res['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$res['id'],'token'=>$res['token'])); else: echo ($res["url"]); endif; ?>"><?php echo ($res["name"]); ?></a><?php endif; ?>
<?php if($ii==4){echo '<div class="clr"></div>
