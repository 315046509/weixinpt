...
<meta charset="utf-8">
<link href="<?php echo RES;?>/css/178/cate101_.css" rel="stylesheet" type="text/css" />
 <link href="<?php echo RES;?>/css/178/iscroll.css" rel="stylesheet" type="text/css" />
...
<script src="<?php echo RES;?>/css/178/jquery.min.js" type="text/javascript"></script>
<script src="<?php echo RES;?>/css/178/swipe.js" type="text/javascript"></script>
<script src="<?php echo RES;?>/css/178/iscroll.js" type="text/javascript"></script>
...
<section>
  <nav class="nav_for_list_ul">
    <div class="ofh">
	  ...
	  <?php if(is_array($info)): $i = 0; $__LIST__ = array_slice($info,4,100,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li   <?php if($i == 1): ?>class="on"<?php endif; ?>  ></li><?php endforeach; endif; else: echo "" ;endif; ?>
              </ul>
      <ul>
        <div id="nav_uls" style="width:33.3%;">
          <ol>

		  <?php if(is_array($info)): $i = 0; $__LIST__ = array_slice($info,4,100,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="javascript:swiper_2.slide(<?php echo ($i-1)%100; ?>);"   <?php if($i == 1): ?>class="on"<?php endif; ?>  ><img src="<?php echo ($vo["img"]); ?>" /><?php echo ($vo["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                       </ol>
        </div>
      </ul>
      <script>
...
this.slide(this.length-3);
  ...
  <div id="list_uls" class="list_uls box_swipe">
    <ul >
	<?php if(is_array($info)): $i = 0; $__LIST__ = array_slice($info,4,100,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(!isset($_GET['classid']) && $vo['fid'] == 0): ?><li>
        <dl>
