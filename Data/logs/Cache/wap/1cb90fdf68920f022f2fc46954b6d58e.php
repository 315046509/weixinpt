...
<!-- share -->
		...
		<script type="text/javascript">
			var imgsrc = $('.text img:first-child').attr('src');
			
			if(typeof(imgsrc) == "undefined"){
				if("<?php echo ($res["pic"]); ?>" == ""){
					imgsrc = "<?php echo ($homeInfo["picurl"]); ?>";
				}else{
					imgsrc = "<?php echo ($res["pic"]); ?>";
				}
			}
			...
			window.shareData = {  
				...
				"tContent": "<?php echo (str_replace('"','',str_replace("\r\n",' ',mb_substr(trim(strip_tags(htmlspecialchars_decode($res["info"]))),0,30,'utf-8')))); ?>"
			};
		</script>	
