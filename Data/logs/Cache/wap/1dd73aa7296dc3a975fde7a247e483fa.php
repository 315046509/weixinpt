<?php if (!defined('THINK_PATH')) exit();?><html><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8" />
		...
		<link href="<?php echo RES;?>/138wocss/109/iscroll.css" rel="stylesheet" type="text/css" />
       ...
       <!--  <link rel="stylesheet" type="text/css" href="<?php echo RES;?>/138wocss/114/iscroll.css" media="all"> -->
        <script type="text/javascript" src="<?php echo RES;?>/138wocss/114/iscroll.js"></script>
