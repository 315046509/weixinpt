...
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/template/home-21.css" media="all" />
...
<div class="body">
  ...
  <div class="head_pic_cirrus"> <img src="<?php echo RES;?>/img/v22_1.png" /> </div>
  <!--
		用户分类管理
		-->
  <section style="padding-bottom:20px">
    <ul class="list_font">
      <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li> <a href="<?php if($vo['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token']));?>
          ...
          <div>
            <p><?php echo ($vo["name"]); ?><small></small></p>
          </div>
