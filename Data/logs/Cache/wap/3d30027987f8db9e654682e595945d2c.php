...
<link href="<?php echo RES;?>/css/163/iscroll.css" rel="stylesheet" type="text/css">
<script src="<?php echo RES;?>/css/163/jquery.min.js" type="text/javascript"></script>
<script src="<?php echo RES;?>/css/163/idangerous.swiper.js" type="text/javascript"></script>
<script src="<?php echo RES;?>/css/163/iscroll.js" type="text/javascript"></script>
    ...
    <div class="clist swiper-container clist<?php echo ($vo["key"]); ?>">
      <div class="swiper-wrapper" style="width: 1295.03125px;">
        <div class="swiper-slide swiper-slide-visible swiper-slide-active" style="width: 1295.03125px;">
          <ul>
            <?php if(is_array($vo['sub'])): $i = 0; $__LIST__ = $vo['sub'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$res): $mod = ($i % 2 );++$i;?><li><a href="<?php if($res['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$res['id'],'token'=>$vo['token']));?>
                <?php else: ?>
                <?php echo (htmlspecialchars_decode($res["url"])); endif; ?>
                ">
                <div><img src="<?php echo ($res["img"]); ?>"></div>
                <span><?php echo ($res["name"]); ?></span></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
          </ul>
        </div>
      </div>
      <script>
