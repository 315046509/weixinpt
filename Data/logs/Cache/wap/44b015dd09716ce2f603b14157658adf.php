...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
		...
		<link href="<?php echo RES;?>/css/119/cate<?php echo ($tpl["tpltypeid"]); ?>_<?php echo ($tpl["color_id"]); ?>.css" rel="stylesheet" type="text/css" />
		<link href="<?php echo RES;?>/css/119/plugmenu.css" rel="stylesheet" type="text/css" />
        <script src="<?php echo RES;?>/css/119/iscroll.js" type="text/javascript"></script>
...
<body>
	...
	<img src="<?php echo RES;?>/css/119/head.png" width="100%" >
	...
	<?php $f=1; ?>
    	...
    	<ul>
		<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($f==1){ $f++; $flat='m1'; }else{ $flat='m2'; $f=1; } echo '<li id="'.$flat.'">'; ?>
                      	<div>
                    ...
                    <span  class="icon" style="background:url(<?php echo ($vo["img"]); ?>) no-repeat;background-size:98px 93px;margin:-26px 0 0;"><em></em></span>
...
<script src="<?php echo RES;?>/css/119/zepto.min.js" type="text/javascript"></script>
<script src="<?php echo RES;?>/css/119/plugmenu.js" type="text/javascript"></script>
<div class="copyright">
