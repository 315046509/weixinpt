...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="<?php echo RES;?>/138wocss/111/iscroll.css" rel="stylesheet" type="text/css"/>
		
        <style>


        </style>
        <script src="<?php echo RES;?>/138wocss/111/iscroll.js" type="text/javascript"></script>
...
<?php if($homeInfo['play_audio'] == 'on'): if($homeInfo['play_wifi'] == 'on'): ?><link rel="stylesheet" href="<?php echo RES;?>/css/auth/login.css" type="text/css">
<script>
...
<?php if($homeInfo['play_audio'] == 'on'): ?><if condition="$homeInfo['musicurl'] neq false">
<style>
.btn_music {
