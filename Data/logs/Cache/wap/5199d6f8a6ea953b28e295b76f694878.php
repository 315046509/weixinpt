...
<div id="queren<?php echo ($item["id"]); ?>" style="display:none;">
								<p style=" margin:10px 0">
									<input name="" type="text" class="px" id="money<?php echo ($item["id"]); ?>" value="" placeholder="请输入实际消费金额">
								</p>
								<p style=" margin:10px 0">
									<input name="" type="text" class="px" id="s_money<?php echo ($item["id"]); ?>" value="" placeholder="请再输入消费金额">
								</p>
...
<script src="<?php echo RES;?>/card/js/alert.js" type="text/javascript"></script> 
<script>
...
function use(i){
	...
	jQ.post('/index.php?g=Wap&m=Card&a=action_usePrivelege', submitData,
	function(data) {
		if (data.success == 1) {
