...
<meta charset="utf-8">
<link href="./tpl/static/tpl/177/css/cate.css" rel="stylesheet" type="text/css" />
...
<body>
		<!--music--><?php if($homeInfo['play_wifi'] == 'on'): ?><link rel="stylesheet" href="<?php echo RES;?>/css/auth/login.css" type="text/css">
<script>
...
<ul class="mainmenu">
    <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php if($vo['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token'])); else: echo (htmlspecialchars_decode($vo["url"])); endif; ?>" ><img src="<?php echo ($vo["img"]); ?>" /><span><?php echo ($vo["name"]); ?></span><p><?php echo ($vo["info"]); ?></p></a></li><?php endforeach; endif; else: echo "" ;endif; ?>	
