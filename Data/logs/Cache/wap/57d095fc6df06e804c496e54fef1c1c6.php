...
<meta charset="utf-8">
<link href="./tpl/static/tpl/180/css/cate.css" rel="stylesheet" type="text/css" />
...
<ul class="mainmenu">
	<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php if($vo['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token'])); else: echo (htmlspecialchars_decode($vo["url"])); endif; ?>" ><em></em><p><span><?php echo ($vo["name"]); ?></span><i><?php echo ($vo["info"]); ?></i></p><b></b></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
