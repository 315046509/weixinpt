...
<link href="<?php echo RES;?>/138wocss/allcss/cate<?php echo ($tpl["tpltypeid"]); ?>_<?php echo ($tpl["color_id"]); ?>.css" rel="stylesheet" type="text/css" />
        ...
        <!-- <link rel="stylesheet" type="text/css" href="<?php echo RES;?>/138wocss/117/common.css" media="all"> -->
        <link rel="stylesheet" type="text/css" href="<?php echo RES;?>/138wocss/117/reset.css" media="all">
        <link rel="stylesheet" type="text/css" href="<?php echo RES;?>/138wocss/117/font-awesome.css" media="all">
        <!-- <link rel="stylesheet" type="text/css" href="<?php echo RES;?>/138wocss/117/home-51.css" media="all"> -->
