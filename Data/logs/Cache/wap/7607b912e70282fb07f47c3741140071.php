...
<?php else: ?> <!--有优惠券的情况下-->
	...
	<?php else: ?><!---->
			...
			<div class="main">
				...
				<div class="boxcontent boxwhite">
						<div class="box">
							...
							<div class="Detail">
							 <p><span class="red"><?php echo ($Coupon["wxname"]); ?> <?php echo ($Coupon["phone"]); ?></span></p>
		...
		<!--都显示-->
			...
			<?php if($wecha_id != ''): ?><div id="zjl" <?php if($Coupon['end'] != 3||($Coupon['end'] == 3&&$Coupon['phone'])){ ?>style="display:none"<?php }?> class="boxcontent boxwhite">
				<!--领到了优惠券start-->
					<div class="box">
...
window.shareData = {  
            ...
            "sendFriendLink": "<?php echo ($f_siteUrl); echo U('Coupon/index',array('token'=>$token,'id'=>$Coupon['id']));?>",
            "tTitle": "<?php echo ($Coupon["title"]); ?>",
            "tContent": "<?php echo ($Coupon["info"]); ?>"
};
</script>
