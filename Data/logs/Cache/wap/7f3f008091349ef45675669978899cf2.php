...
<meta charset="utf-8">
<link href="<?php echo RES;?>/css/allcss/cate82_.css" rel="stylesheet" type="text/css" />
...
<?php $ii=1; ?> 
<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($ii==1){echo '<ul>';} ?>  
<li>
<div class="menubtn">
...
<?php if($ii==2){echo '</ul>';} $ii++; if($ii>2)$ii=1; endforeach; endif; else: echo "" ;endif; ?>
<?php if($ii<>1){echo '</ul>';} ?>
<script>
