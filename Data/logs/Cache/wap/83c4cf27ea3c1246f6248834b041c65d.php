...
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/138wocss/130/reset.css" media="all">
<script type="text/javascript" src="<?php echo RES;?>/138wocss/130/maivl.js"></script>
<script type="text/javascript" src="<?php echo RES;?>/138wocss/116/jQuery.js"></script>
<script type="text/javascript" src="<?php echo RES;?>/138wocss/130/swipe.js"></script>
<script type="text/javascript" src="<?php echo RES;?>/138wocss/130/zepto.js"></script>
    </head>
...
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/138wocss/130/font-awesome.css" media="all">
        ...
        <section>
            ...
            <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li>
                        <a href="<?php if($vo['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token'])); else: echo (htmlspecialchars_decode($vo["url"])); endif; ?>">
                                ...
                                <figcaption><?php echo ($vo["name"]); ?> </figcaption>
                            </figure>
                        </a>
                    </li><?php endforeach; endif; else: echo "" ;endif; ?>
