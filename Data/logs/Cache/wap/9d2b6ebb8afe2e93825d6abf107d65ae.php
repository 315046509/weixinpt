...
<head>
<meta charset="utf-8" />
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/140/css/snower.css?2013-12-09-1" media="all" />
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/140/css/weimob-ui-1-1.css?2013-12-09-1" media="all" />
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/140/css/common.css?2013-12-09-1" media="all" />
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/140/css/home-0.css?2013-12-09-1" media="all" />
<script type="text/javascript" src="<?php echo RES;?>/css/140/js/maivl.js?2013-12-09-1"></script>
<script type="text/javascript" src="<?php echo RES;?>/css/140/js/jQuery.js?2013-12-09-1"></script>
<script type="text/javascript" src="<?php echo RES;?>/css/140/js/swipe.js?2013-12-09-1"></script>
<script type="text/javascript" src="<?php echo RES;?>/css/140/js/zepto.js?2013-12-09-1"></script>
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/reset.css?2013-9-13-2" media="all" />
...
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/140/font/font-awesome.css?v=2013121115" media="all" />
<div class="weimob-page" style="display:block; padding-bottom:55px;">
  ...
  <div style="-webkit-transform:translate3d(0,0,0);">
    <div style="-webkit-transform:translate3d(0,0,0);">
      <div id="banner_box" class="box_swipe">
        <ul>
          <?php if(is_array($flash)): $i = 0; $__LIST__ = $flash;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$so): $mod = ($i % 2 );++$i;?><li> <a onClick="return false;"> <img src="<?php echo ($so["img"]); ?>" alt="1" style="width:100%;" /> </a> </li><?php endforeach; endif; else: echo "" ;endif; ?>
        </ul>
        <ol>
  ...
  <header>
    <div class="snower">
      ...
      <script type="text/javascript" src="<?php echo RES;?>/css/140/js/snower.js"></script>
    </div>
  </header>
  <!--
		用户分类管理
    ...
    <div class="weimob-list">
      <?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><a href="<?php if($vo['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token']));?>
        ...
        <div class="weimob-list-item-bg">
          <div> <img src="<?php echo ($vo["img"]); ?>" style="width:100%;" /> </div>
          <div class="weimob-list-item-box">
            <div class="weimob-list-item-line">
              <div class="weimob-list-item-title"><?php echo ($vo["name"]); ?></div>
            </div>
          </div>
        </div>
