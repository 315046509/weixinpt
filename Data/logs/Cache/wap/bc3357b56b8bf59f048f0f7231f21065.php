...
<meta charset="utf-8">
<link href="<?php echo RES;?>/css/179/cate100_.css" rel="stylesheet" type="text/css" />
 <link href="<?php echo RES;?>/css/179/iscroll.css" rel="stylesheet" type="text/css" />
...
<script src="<?php echo RES;?>/css/179/jquery.min.js" type="text/javascript"></script>
<script src="<?php echo RES;?>/css/179/swipe.js" type="text/javascript"></script>
<script src="<?php echo RES;?>/css/179/iscroll.js" type="text/javascript"></script>
...
<div class="imgmenu">
<ul>
<?php if(is_array($info)): $i = 0; $__LIST__ = array_slice($info,0,4,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php if($vo['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token'])); else: echo ($vo["url"]); endif; ?>"><img src="<?php echo ($vo["img"]); ?>" /><p><?php echo ($vo["name"]); ?></p></a></li><?php endforeach; endif; else: echo "" ;endif; ?>      

  </ul><ul>
 <?php if(is_array($info)): $i = 0; $__LIST__ = array_slice($info,4,8,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="<?php if($vo['url'] == ''): echo U('Wap/Index/lists',array('classid'=>$vo['id'],'token'=>$vo['token'])); else: echo ($vo["url"]); endif; ?>"><img src="<?php echo ($vo["img"]); ?>" /><p><?php echo ($vo["name"]); ?></p></a></li><?php endforeach; endif; else: echo "" ;endif; ?> 
</ul>
</div>
...
<section>
  <nav class="nav_for_list_ul">
    <div class="ofh">
      <ul>
            <?php if(is_array($info)): $i = 0; $__LIST__ = array_slice($info,8,100,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li   <?php if($i == 1): ?>class="on"<?php endif; ?>  ></li><?php endforeach; endif; else: echo "" ;endif; ?>
              </ul>
      <ul>
        <div id="nav_uls" style="width:33.3%;">
          <ol>
                      <?php if(is_array($info)): $i = 0; $__LIST__ = array_slice($info,8,100,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><li><a href="javascript:swiper_2.slide(<?php echo ($i-1)%100; ?>);"   <?php if($i == 1): ?>class="on"<?php endif; ?>  ><img src="<?php echo ($vo["img"]); ?>" /><?php echo ($vo["name"]); ?></a></li><?php endforeach; endif; else: echo "" ;endif; ?>
                       </ol>
        </div>
      </ul>
      <script>
...
this.slide(this.length-3);
  ...
  <div id="list_uls" class="list_uls box_swipe">
    <ul >
      <?php if(is_array($info)): $i = 0; $__LIST__ = array_slice($info,8,100,true);if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if(!isset($_GET['classid']) && $vo['fid'] == 0): ?><li>
        <dl>
