...
<link href="<?php echo RES;?>/css/148/iscroll.css" rel="stylesheet" type="text/css">
<script src="<?php echo RES;?>/css/148/jquery.min.js" type="text/javascript"></script>
<script src="<?php echo RES;?>/css/148/idangerous.swiper.js" type="text/javascript"></script>
<script src="<?php echo RES;?>/css/148/iscroll.js" type="text/javascript"></script>
...
<?php if(is_array($info)): $i = 0; $__LIST__ = $info;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i; if($vo['key'] < 4): ?><div class="catemenu " >
