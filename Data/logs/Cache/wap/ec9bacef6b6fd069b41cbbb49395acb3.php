...
<div class="qiandaobanner">  <a   href="javascript:history.go(-1);"><img src="<?php echo ($thisCard["contact"]); ?>" > </a></div>
...
<div class="accordion_child">
<p class="xiangqing"><?php echo ($thisCompany["intro"]); ?></p>
</div>
</div>
</div>
</div>
