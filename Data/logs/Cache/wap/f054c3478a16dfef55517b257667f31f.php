...
<link rel="stylesheet" type="text/css" href="<?php echo RES;?>/css/template/home-49.css" media="all" />
...
<div class="body">
  <section>
    ...
    <div class="logo"> <img src="<?php if($homeInfo["picurl"] != false): echo ($homeInfo["picurl"]); ?>
      <?php else: echo RES;?>/images/themes/huifu.png<?php endif; ?>
