		...
		init : function(options, swfUploadOptions) {
			...
			return this.each(function() {
				...
				var settings = $.extend({
					...
					swf      : 'http://www.iMicms.com/uploadify/uploadify.swf',  // The path to the uploadify SWF file
					uploader : 'http://www.iMicms.com/uploadify/uploadify.php',  // The path to the server-side upload script
